 ...
 * @author hoffmann
 */
public class ConfigurationServiceStub implements ConfigurationService, ConfigurationServiceLocal {

  private final Map<ConfigurationKey, ConfigurationSetting> settings =
      new HashMap<ConfigurationKey, ConfigurationSetting>();
  ...
  public ConfigurationSetting getConfigurationSetting(
    ...
    return new ConfigurationSetting(
        informationId, Configuration.GLOBAL_CONTEXT, informationId.getFallBackValue());
  }
  ...
  public void setConfigurationSetting(ConfigurationKey key, String value) {
    ConfigurationSetting configSetting =
        new ConfigurationSetting(key, Configuration.GLOBAL_CONTEXT, value);
    settings.put(configSetting.getInformationId(), configSetting);
  }
  ...
  long getConfiguredBillingOffsetInMs() {
    long configuredValue =
        getLongConfigurationSetting(
            ConfigurationKey.TIMER_INTERVAL_BILLING_OFFSET, Configuration.GLOBAL_CONTEXT);
  ...
  public String getBaseURL() {
    return getConfigurationSetting(ConfigurationKey.BASE_URL, Configuration.GLOBAL_CONTEXT)
        .getValue();
  }

  @Override
  public String getBaseUrlHttps() {
    return getConfigurationSetting(ConfigurationKey.BASE_URL_HTTPS, Configuration.GLOBAL_CONTEXT)
        .getValue();
  }

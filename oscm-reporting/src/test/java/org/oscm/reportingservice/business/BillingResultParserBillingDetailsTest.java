...
public class BillingResultParserBillingDetailsTest {
    ...
    private final String XML_FILE_BILLING_DETAILS = "/BillingResultForBillingDetailsTest.xml";
    ...
    public void evaluateBillingResultForBillingDetails_SubscriptionSuspendedAndActived()
        ...
        File file = new File(this.getClass().getResource(XML_FILE_BILLING_DETAILS).getFile());

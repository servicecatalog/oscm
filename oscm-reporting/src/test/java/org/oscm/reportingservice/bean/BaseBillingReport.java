...
import org.oscm.reportingservice.stubs.*;
...
public abstract class BaseBillingReport {
    ...
    protected static final String XML_FILE_1 = "/BillingResult.xml";
    protected static final String XML_FILE_2 = "/BillingResult2.xml";
    protected static final String XML_FILE_3 = "/BillingResult3.xml";
    protected static final String XML_FILE_4 = "/BillingResult4.xml";
    protected static final String XML_FILE_6 = "/BillingResult6.xml";
    protected static final String XML_FILE_STEPPEDPRICES = "/SteppedPrices.xml";
    protected static final String XML_FILE_OPTIONS = "/Options.xml";
    protected static final String XML_FILE_UPGRADE = "/Upgrade.xml";
    protected static final String XML_FILE_ZEROPRICES = "/ZeroPrices.xml";
    protected static final String XML_PER_TIMEUNIT = "/BillingResultPerTimeUnit.xml";
    protected static final String XML_NO_CALCULATIONMODE = "/BillingResultWithoutCalculationMode.xml";
    ...
    public void setUp() throws Exception {
        File file = new File(this.getClass().getResource(XML_FILE_1).getFile());
        filesToUse.add(file);

...
@XmlType(name = "", propOrder = { "brokers", "resellers", "suppliers",
        "marketplaceOwner" })
@XmlRootElement(name = "RevenuesPerMarketplace")
public class RevenuesPerMarketplace {
    ...
    public void setBrokers(Brokers value) {
        this.brokers = value;
    }
    ...
    public void setResellers(Resellers value) {

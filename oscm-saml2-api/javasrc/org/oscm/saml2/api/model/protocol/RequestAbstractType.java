...
@XmlType(name = "RequestAbstractType", propOrder = { "issuer", "signature",
        "extensions" })
@XmlSeeAlso({ ArtifactResolveType.class, ManageNameIDRequestType.class,
        LogoutRequestType.class, AuthnRequestType.class,
        AssertionIDRequestType.class, SubjectQueryAbstractType.class,

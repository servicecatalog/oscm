...
public enum ContactTypeType {
    ...
    TECHNICAL("technical"), @XmlEnumValue("support")
    SUPPORT("support"), @XmlEnumValue("administrative")
    ADMINISTRATIVE("administrative"), @XmlEnumValue("billing")
    BILLING("billing"), @XmlEnumValue("other")
    OTHER("other");

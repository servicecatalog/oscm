...
public class SAMLResponseExtractorTest {
    ...
    private final String FILE_UNSIGNED_RESPONSE = "/unsignedResponse.xml";
    private final String FILE_UNSIGNED_LOGOUT_RESPONSE = "/openamUnsignedLogoutResponse.xml";
    private final String FILE_UNSIGNED_RESPONSE_MISSING_USERID = "/unsignedResponse_missingUserid.xml";
    private final String FILE_UNSIGNED_ASSERTION = "/unsignedAssertion.xml";
    private final String FILE_UNSIGNED_ASSERTION_MISSING_USERID = "/unsignedAssertion_noConfirmationData_noUserid.xml";

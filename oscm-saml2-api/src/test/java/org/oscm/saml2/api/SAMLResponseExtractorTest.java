...
public class SAMLResponseExtractorTest {
    ...
    private final String FILE_UNSIGNED_RESPONSE = "LongunsignedResponse.xml";
    private final String FILE_UNSIGNED_LOGOUT_RESPONSE = "LongopenamUnsignedLogoutResponse.xml";
    private final String FILE_UNSIGNED_RESPONSE_MISSING_USERID = "LongunsignedResponse_missingUserid.xml";
    private final String FILE_UNSIGNED_ASSERTION = "LongunsignedAssertion.xml";
    private final String FILE_UNSIGNED_ASSERTION_MISSING_USERID = "LongunsignedAssertion_noConfirmationData_noUserid.xml";

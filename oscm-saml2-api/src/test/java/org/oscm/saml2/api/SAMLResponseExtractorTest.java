...
public class SAMLResponseExtractorTest {
    ...
    private final String FILE_UNSIGNED_RESPONSE = "src/test/resources/unsignedResponse.xml";
    private final String FILE_UNSIGNED_LOGOUT_RESPONSE = "src/test/resources/openamUnsignedLogoutResponse.xml";
    private final String FILE_UNSIGNED_RESPONSE_MISSING_USERID = "src/test/resources/unsignedResponse_missingUserid.xml";
    private final String FILE_UNSIGNED_ASSERTION = "src/test/resources/unsignedAssertion.xml";
    private final String FILE_UNSIGNED_ASSERTION_MISSING_USERID = "src/test/resources/unsignedAssertion_noConfirmationData_noUserid.xml";

...
public class AppConfigurationCtrl extends BaseCtrl {
        ...
        public String getInitialize() {
                ...
                try {
                        ...
                        if (!model.isInitialized()) {
                                ...
                                model.setControllerIds(
                                        new HashSet<String>(model.getItems()
                                                .keySet()));
                ...
                try {
                        ...
                        for (String controllerId : store.keySet()) {
                                if (isEmpty(store.get(controllerId))) {
                                        addError(
                                                ERROR_ORGANIZATIONID_MANDATORY);
                                        return OUTCOME_SAMEPAGE;
                                }
                        }
                        ...
                        getAppConfigService()
                                .storeControllerOrganizations(store);
        ...
        private boolean checkAddController() {
                ...
                if (notIsEmpty(newControllerId)) {
                        if (model.getItems()
                                .containsKey(newControllerId.trim())) {
                                addError(ERROR_CONTROLLERID_EXISTS);
                                return false;
                        }
                }
                if (notIsEmpty(newControllerId) && notIsEmpty(
                        newOrganizationId)) {
        ...
        /**
         * Tries to invoke controller's implementation of canPing() method.
         * Checks if controller of specified ID is properly configured.
         * According to results, sets visibility of 'Check connection' button
         *
        ...
        public void invokeCanPing(String controllerId) {
                ...
                try {
                        if (Configuration.pingableControllersList
        ...
        /**
         * Updates pingButtonVisibilityMap with 'Check connection' buttons visibility settings
         * according to the outcome of canPing() implementations
         *
         * @param updatedMap pingButtonVisibilityMap updated with new
         *                   'Check connection' buttons visibility settings
         */
        private void updatePingButtonVisibilityMap(
                Map<String, Boolean> updatedMap) {
        ...
        private APPlatformController getControllerInstance(String controllerId)
                ...
                if (!controllerInstanceMap.containsKey(controllerId))
                        controllerInstanceMap.put(
                                controllerId, APPlatformControllerFactory
        ...
        /**
         * Constructs CanPingErrorWrapper and adds it to the set of canPing exception,
         * that are further presented to the user
         *
         ...
         */
        private void displayDetailedError(String errorMessage,
                String stackTrace) {
                model.addCanPingException(
                        new CanPingErrorWrapper(errorMessage, stackTrace));
        }
}
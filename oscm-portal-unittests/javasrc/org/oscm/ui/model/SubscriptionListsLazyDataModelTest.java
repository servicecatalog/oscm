 ...
 *
 * <p>Creation Date: 15.05.15 09:34
 *
 * <p>*****************************************************************************
 */
...
public class SubscriptionListsLazyDataModelTest {
  ...
  private SubscriptionListsLazyDataModel beanUnderTheTest =
      spy(new SubscriptionListsLazyDataModel());
  ...
  public void bug11725() {
    ...
    assertEquals(
        ...
        beanUnderTheTest.getSortOrders().get(beanUnderTheTest.getACTIVATION()));
  }
  ...
  public void testGetDataList() throws Exception {
    ...
    when(subscriptionsService.getSubscriptionsForOrgWithFiltering(
            anySet(), any(PaginationFullTextFilter.class)))
        .thenReturn(resp);
    when(subscriptionsService.getSubscriptionsForOrgSizeWithFiltering(
            anySet(), any(PaginationFullTextFilter.class)))
    ...
    doNothing()
        .when(beanUnderTheTest)
        .decorateWithLocalizedStatuses(any(org.oscm.paginator.Pagination.class));
    beanUnderTheTest.setSubscriptionsService(subscriptionsService);

    // when
    List<POSubscriptionForList> result =
        beanUnderTheTest.getDataList(
            firstRow,
            numRows,
  ...
  public void testGetTotalCount() throws Exception {
    ...
    verify(subscriptionsService, atLeastOnce())
        .getSubscriptionsForOrgSizeWithFiltering(anySet(), any(PaginationFullTextFilter.class));
  }

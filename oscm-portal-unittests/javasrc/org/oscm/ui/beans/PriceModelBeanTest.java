 ...
 *
 * <p>Creation Date: Nov 4, 2011
 *
 * <p>Completion Time: Nov 4, 2011
 *
 * <p>*****************************************************************************
 */
...
public class PriceModelBeanTest {
  ...
  private static final int PRICEMODEL_FOR_SUBSCRIPTION = 3;
  ...
  public void setup() throws Exception {
    ...
    provisioningServiceInternal = spy(new ServiceProvisioningServiceInternalBean());
    provisioningService =
        spy(
            new ServiceProvisioningServiceBean() {
              @Override
              ...
              public VOServiceDetails savePriceModelForCustomer(
                  VOServiceDetails productDetails, VOPriceModel priceModel, VOOrganization customer)
                  throws OrganizationAuthoritiesException, ObjectNotFoundException,
  ...
  public void updatePriceModel_Bug10641() {
    ...
    assertEquals(
        1,
        bean.getParametersRoles().get(0).getPricedParameter().getRoleSpecificUserPrices().size());
  }
  ...
  public void save_Bug12158() throws Exception {
    ...
    doReturn(bean.getSelectedService())
        .when(provisioningService)
        .savePriceModel(any(VOServiceDetails.class), any(VOPriceModel.class));
    doNothing()
        .when(provisioningService)
        .savePriceModelLocalization(any(VOPriceModel.class), any(VOPriceModelLocalization.class));
    // when
    bean.save();
    // then
    verify(provisioningService, atLeastOnce())
        .savePriceModelLocalization(any(VOPriceModel.class), any(VOPriceModelLocalization.class));
  }
  ...
  public void save_subscription_SubscriptionStateException() throws Exception {
    ...
    doThrow(new SubscriptionStateException())
        .when(provisioningService)
        .savePriceModelForSubscription(any(VOServiceDetails.class), any(VOPriceModel.class));
    doReturn(vOServiceDetails)
        .when(provisioningService)
        .getServiceForSubscription(any(VOOrganization.class), anyString());
    // when
    try {
      bean.save();
      fail();
  ...
  public void testValidateSubscription() throws SaaSApplicationException {
    // given
    doReturn(new VOSubscriptionDetails())
        .when(provisioningService)
  ...
  private List<POSubscriptionAndCustomer> givenPOSubscriptionAndCustomersList() {
    List<POSubscriptionAndCustomer> poSubscriptionAndCustomers =
        new ArrayList<POSubscriptionAndCustomer>();

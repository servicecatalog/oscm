...
public class AuthenticationSettingsTest {
	...
	private void givenMock(AuthenticationMode authMode, String idpUrl)
		...
		doReturn(new VOConfigurationSetting(ConfigurationKey.AUTH_MODE, Configuration.GLOBAL_CONTEXT, authMode.name()))
				.when(cfgMock).getVOConfigurationSetting(ConfigurationKey.AUTH_MODE, Configuration.GLOBAL_CONTEXT);
		doReturn(new VOConfigurationSetting(ConfigurationKey.SSO_IDP_URL, Configuration.GLOBAL_CONTEXT, idpUrl))
				.when(cfgMock).getVOConfigurationSetting(ConfigurationKey.SSO_IDP_URL, Configuration.GLOBAL_CONTEXT);
		doReturn(new VOConfigurationSetting(ConfigurationKey.SSO_ISSUER_ID, Configuration.GLOBAL_CONTEXT, idpUrl))
				.when(cfgMock).getVOConfigurationSetting(ConfigurationKey.SSO_ISSUER_ID, Configuration.GLOBAL_CONTEXT);
		doReturn(new VOConfigurationSetting(ConfigurationKey.BASE_URL, Configuration.GLOBAL_CONTEXT, idpUrl))
				.when(cfgMock).getVOConfigurationSetting(ConfigurationKey.BASE_URL, Configuration.GLOBAL_CONTEXT);
		doReturn(new VOConfigurationSetting(ConfigurationKey.SSO_SIGNING_KEY_ALIAS, Configuration.GLOBAL_CONTEXT,
				IDP_KEYSTORE_PASS)).when(cfgMock).getVOConfigurationSetting(ConfigurationKey.SSO_SIGNING_KEY_ALIAS,
						Configuration.GLOBAL_CONTEXT);
		doReturn(new VOConfigurationSetting(ConfigurationKey.SSO_SIGNING_KEYSTORE_PASS, Configuration.GLOBAL_CONTEXT,
				IDP_KEYSTORE_PASS)).when(cfgMock).getVOConfigurationSetting(ConfigurationKey.SSO_SIGNING_KEYSTORE_PASS,
						Configuration.GLOBAL_CONTEXT);
		doReturn(new VOConfigurationSetting(SSO_SIGNING_KEYSTORE, Configuration.GLOBAL_CONTEXT, IDP_KEYSTORE_PASS))
				.when(cfgMock).getVOConfigurationSetting(SSO_SIGNING_KEYSTORE, Configuration.GLOBAL_CONTEXT);
		doReturn(new VOConfigurationSetting(SSO_DEFAULT_TENANT_ID, Configuration.GLOBAL_CONTEXT, "tenantID"))
				.when(cfgMock).getVOConfigurationSetting(SSO_DEFAULT_TENANT_ID, Configuration.GLOBAL_CONTEXT);

 ...
 * 
 */
public class SubscriptionPriceEventQuery extends UserOperationLogQuery {

    private static final String SUBSCR_PRICE_EVENT = "";
    ...
    public LogMessageIdentifier getLogMessageIdentifier() {
        return LogMessageIdentifier.INFO_OPERATION_LOG_SUBSCR_PRICE_EVENT;
    }

    @Override
    public String getQuery() {
        return SUBSCR_PRICE_EVENT;
    }

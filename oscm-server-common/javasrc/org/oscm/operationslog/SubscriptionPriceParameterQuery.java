 ...
 * 
 */
public class SubscriptionPriceParameterQuery extends UserOperationLogQuery {

    private static final String SUBSCR_PRICE_PARAM = "";
    ...
    public LogMessageIdentifier getLogMessageIdentifier() {
        return LogMessageIdentifier.INFO_OPERATION_LOG_SUBSCR_PRICE_PARAM;
    }

    @Override
    public String getQuery() {
        return SUBSCR_PRICE_PARAM;
    }

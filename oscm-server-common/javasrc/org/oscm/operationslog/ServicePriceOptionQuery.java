 ...
 * 
 */
public class ServicePriceOptionQuery extends UserOperationLogQuery {

    private static final String SERVICE_PRICE_OPTION = "";

    private static final String[] fieldNames = new String[] {
            COMMON_COLUMN_MODDATE, "op", "user", COMMON_COLUMN_OBJVERSION,
            "service", "supplier", "id", "parameter", "option", "price",
            "price per user", "currency" };

    @Override
    public LogMessageIdentifier getLogMessageIdentifier() {
        return LogMessageIdentifier.INFO_OPERATION_LOG_SERVICE_PRICE_OPTION;
    }

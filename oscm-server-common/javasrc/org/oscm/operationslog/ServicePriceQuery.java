 ...
 * 
 */
public class ServicePriceQuery extends UserOperationLogQuery {

    private static final String SERVICE_PRICE = "";

    private static final String[] fieldNames = new String[] {
            COMMON_COLUMN_MODDATE, "op", "user", COMMON_COLUMN_OBJVERSION,
            "service", "supplier", "id", "free", "one time fee", "period",
            "price", "price per user", "currency" };

    @Override
    public LogMessageIdentifier getLogMessageIdentifier() {
        return LogMessageIdentifier.INFO_OPERATION_LOG_SERVICE_PRICE;
    }

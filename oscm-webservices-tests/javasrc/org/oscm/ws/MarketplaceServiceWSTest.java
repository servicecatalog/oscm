...
public class MarketplaceServiceWSTest {
  ...
  public void testCreateGlobalMarketplaceForOperator() throws Exception {
    VOMarketplace marketplace = factory.createMarketplaceVO(PLATFORM_OPERATOR, false, "globalMp");
    createAndValidateMarketplace(marketplace);
  }

  @Test
  public void testCreateGlobalMarketplaceForOperator2() throws Exception {
    VOMarketplace marketplace = factory.createMarketplaceVO(null, false, "globalMp");
    createAndValidateMarketplace(marketplace);
  }
  ...
  public void testCreateGlobalMarketplaceForSupplier() throws Exception {
    VOMarketplace marketplace =
        factory.createMarketplaceVO(supplier.getOrganizationId(), false, "globalMp");
    createAndValidateMarketplace(marketplace);
  }

  @Test
  public void testCreateLocalMarketplaceForOperator() throws Exception {
    VOMarketplace marketplace = factory.createMarketplaceVO(PLATFORM_OPERATOR, false, "localMp");
    createAndValidateMarketplace(marketplace);
  }
  ...
  public void testCreateGlobalMarketplaceMarketplaceIdInUse() throws Exception {
    ...
    VOMarketplace marketplace = factory.createMarketplaceVO(PLATFORM_OPERATOR, false, "Mp1", MP_ID);
    mpService_Operator.createMarketplace(marketplace);
    VOMarketplace marketplaceGet = mpService_Operator.getMarketplaceById(MP_ID);
    assertEquals(MP_ID, marketplaceGet.getMarketplaceId());
    VOMarketplace marketplace2 =
        factory.createMarketplaceVO(PLATFORM_OPERATOR, false, "Mp2", MP_ID);
    mpService_Operator.createMarketplace(marketplace2);
    fail();
  }

  @Test(expected = ObjectNotFoundException.class)
  public void testCreateMarketplaceWithNotExistingOrganization() throws Exception {
    VOMarketplace marketplace = factory.createMarketplaceVO("432954353", false, "globalMp");
    createAndValidateMarketplace(marketplace);
  }

  @Test
  public void testCreateMarketplaceWithMarketplaceConfiguration() throws Exception {
    VOMarketplace marketplace = factory.createMarketplaceVO(PLATFORM_OPERATOR, false, "localMp");
    ...
    VOMarketplace marketplace2 =
        mpService_Operator.getMarketplaceById(marketplace.getMarketplaceId());

    assertEquals(marketplace.isReviewEnabled(), marketplace2.isReviewEnabled());

    marketplace.setTaggingEnabled(true);
    marketplace.setReviewEnabled(true);
    mpService_Operator.updateMarketplace(marketplace);
    marketplace2 = mpService_Operator.getMarketplaceById(marketplace.getMarketplaceId());
    assertEquals(marketplace.isReviewEnabled(), marketplace2.isReviewEnabled());
  }

  @Test(expected = ValidationException.class)
  public void testCreateMarketplaceWithMissingMarketplaceName() throws Exception {
    VOMarketplace marketplace =
        factory.createMarketplaceVO(supplier.getOrganizationId(), false, null); // name
    // not
    // set
    createAndValidateMarketplace(marketplace);
  }
  ...
  @Test
  public void testChangeMarketplaceNameAndMarketplaceOwnerIsAvailable() throws Exception {
    VOMarketplace marketplace = factory.createMarketplaceVO(PLATFORM_OPERATOR, false, "localMp");
    ...
    is.grantUserRoles(
        ...
        new ArrayList<UserRoleType>(EnumSet.of(UserRoleType.MARKETPLACE_OWNER)));
  ...
  public void testUpdateMarketplaceConcurrentlyChanged() throws Exception {
    ...
    marketplace = mpService_Operator.getMarketplaceById(marketplace.getMarketplaceId());
    assertNotNull(marketplace);
    assertTrue(marketplace.getKey() > 0);
    assertEquals(0, marketplace.getVersion());

    marketplace.setOwningOrganizationId(supplier.getOrganizationId());
    VOMarketplace marketplaceAfterUpdate = mpService_Operator.updateMarketplace(marketplace);
    assertEquals(0, marketplace.getVersion());
    ...
    marketplaceAfterUpdate.setOwningOrganizationId(supplier.getOrganizationId());
    mpService_Operator.updateMarketplace(marketplaceAfterUpdate);
  }

  @Test
  public void testUpdateMarketplaceName_ConcurrentlyChanged() throws Exception {
    VOMarketplace marketplace = factory.createMarketplaceVO(PLATFORM_OPERATOR, false, "localMp");
  ...
  public void testDeleteMarketplace() throws Exception {
    VOMarketplace marketplace =
        factory.createMarketplaceVO(supplier.getOrganizationId(), false, "abc");
  ...
  public void testDeleteMarketplaceWithWrongRole() throws Exception {
    ...
    try {
      ...
      mpService_Supplier.deleteMarketplace(marketplace.getMarketplaceId());
      fail();
    } catch (SOAPFaultException e) {
      checkAccessException(e);
    }
  ...
  public void testDeleteMarketplaceWithServices() throws Exception {
    ...
    VOServiceEntry serviceEntry =
        setup
            .getServiceProvisioningSrvAsSupplier()
            .getServiceForMarketplace(
                Long.valueOf(freeService.getKey()), marketplace.getMarketplaceId(), "en");
  ...
  public void testAddSupplierToMarketplace_OpenMarketplace() throws Exception {
    VOMarketplace marketplace =
        factory.createMarketplaceVO(PLATFORM_OPERATOR, true, "globalOpenMp");
    marketplace = createAndValidateMarketplace(marketplace);

    addSupplierToMarketplace(marketplace, mpService_Operator, supplier.getOrganizationId(), 0);
  }
  ...
  @Test(expected = ObjectNotFoundException.class)
  public void testAddSupplierToMarketplaceWithNotExistingSupplier() throws Exception {
    VOMarketplace marketplace = factory.createMarketplaceVO(PLATFORM_OPERATOR, false, "globalMp");
    marketplace = createAndValidateMarketplace(marketplace);
  ...
  public void testAddSupplierToMarketplace_DuplicateSupplier() throws Exception {
    VOMarketplace marketplace = factory.createMarketplaceVO(PLATFORM_OPERATOR, false, "globalMp");
    marketplace = createAndValidateMarketplace(marketplace);

    addSupplierToMarketplace(marketplace, mpService_Operator, supplier.getOrganizationId(), 0);

    addSupplierToMarketplace(marketplace, mpService_Operator, supplier.getOrganizationId(), 1);
  }

  @Test(expected = MarketplaceAccessTypeUneligibleForOperationException.class)
  public void removeSuppliersFromMarketplace_OpenMarketplace() throws Exception {
    VOMarketplace marketplace =
        factory.createMarketplaceVO(PLATFORM_OPERATOR, true, "globalOpenMp");
    marketplace = createAndValidateMarketplace(marketplace);
    ...
    mpService_Operator.removeOrganizationsFromMarketplace(
        organizationIds, marketplace.getMarketplaceId());
  }
  ...
  public void removeSuppliersFromMarketplace() throws Exception {
    ...
    List<VOOrganization> mpSuppliers =
        mpService_Operator.getOrganizationsForMarketplace(marketplace.getMarketplaceId());
  ...
  @Test(expected = OperationNotPermittedException.class)
  public void removeSupplierFromMarketplaceWithMissingRoles() throws Exception {
  ...
  @Test(expected = MarketplaceAccessTypeUneligibleForOperationException.class)
  public void testBanSupplierFromMarketplace_ClosedMarketplace() throws Exception {
    VOMarketplace marketplace = factory.createMarketplaceVO(PLATFORM_OPERATOR, false, "globalMp");
    marketplace = createAndValidateMarketplace(marketplace);

    banSupplierFromMarketplace(marketplace, mpService_Operator, supplier.getOrganizationId(), 0);
  }
  ...
  public void testBanSupplierFromMarketplaceWithWrongRole() throws Exception {
    VOMarketplace marketplace =
        factory.createMarketplaceVO(supplier.getOrganizationId(), true, "globalOpenMp");
    marketplace = createAndValidateMarketplace(marketplace);
  ...
  @Test(expected = ObjectNotFoundException.class)
  public void testBanSupplierFromMarketplaceWithNotExistingSupplier() throws Exception {
    VOMarketplace marketplace =
        factory.createMarketplaceVO(PLATFORM_OPERATOR, true, "globalOpenMp");
    marketplace = createAndValidateMarketplace(marketplace);

    banSupplierFromMarketplace(marketplace, mpService_Operator, "fhdsjkh", 0);
  }

  @Test(expected = OrganizationAlreadyBannedException.class)
  public void testBanSupplierFromMarketplace_DuplicateSupplier() throws Exception {
    VOMarketplace marketplace =
        factory.createMarketplaceVO(PLATFORM_OPERATOR, true, "globalOpenMp");
    marketplace = createAndValidateMarketplace(marketplace);
    ...
    banSupplierFromMarketplace(marketplace, mpService_Operator, supplier.getOrganizationId(), 1);
  }

  @Test(expected = MarketplaceAccessTypeUneligibleForOperationException.class)
  public void liftBannedSuppliersFromMarketplace_ClosedMarketplace() throws Exception {
    VOMarketplace marketplace = factory.createMarketplaceVO(PLATFORM_OPERATOR, false, "globalMp");
    marketplace = createAndValidateMarketplace(marketplace);

    List<String> organizationIds = new LinkedList<String>();
    organizationIds.add(supplier.getOrganizationId());
    mpService_Operator.liftBanOrganizationsFromMarketplace(
        organizationIds, marketplace.getMarketplaceId());
  }
  ...
  public void liftBannedSuppliersFromMarketplace() throws Exception {
    ...
    List<VOOrganization> mpSuppliers =
        mpService_Operator.getBannedOrganizationsForMarketplace(marketplace.getMarketplaceId());
    assertNotNull(mpSuppliers);
  ...
  @Test(expected = ObjectNotFoundException.class)
  public void liftBannedSuppliersFromNonExistingMarketplace() throws Exception {
    VOMarketplace marketplace =
        factory.createMarketplaceVO(PLATFORM_OPERATOR, true, "globalOpenMp");
    marketplace.setMarketplaceId("5434354");
  ...
  @Test(expected = OperationNotPermittedException.class)
  public void liftBannedSuppliersFromMarketplaceWithMissingRoles() throws Exception {
  ...
  @Test(expected = ObjectNotFoundException.class)
  public void testGetSuppliersForMarketplaceWithInvalidMarketplaceId() throws Exception {
    mpService_Operator.getOrganizationsForMarketplace("fdesfgsd");
  }

  @Test(expected = MarketplaceAccessTypeUneligibleForOperationException.class)
  public void testGetSuppliersForMarketplace_OpenMarketplace() throws Exception {
    VOMarketplace marketplace =
        factory.createMarketplaceVO(PLATFORM_OPERATOR, true, "globalOpenMp");
    marketplace = createAndValidateMarketplace(marketplace);
    mpService_Operator.getOrganizationsForMarketplace(marketplace.getMarketplaceId());
  ...
  @Test(expected = MarketplaceAccessTypeUneligibleForOperationException.class)
  public void testGetBannedSuppliersFromMarketplace_ClosedMarketplace() throws Exception {
    VOMarketplace marketplace = factory.createMarketplaceVO(PLATFORM_OPERATOR, false, "globalMp");
    marketplace = createAndValidateMarketplace(marketplace);
    mpService_Operator.getBannedOrganizationsForMarketplace(marketplace.getMarketplaceId());
  }
  ...
  @Test(expected = ObjectNotFoundException.class)
  public void testGetBannedSuppliersFromMarketplaceWithInvalidMarketplaceId() throws Exception {
    mpService_Operator.getBannedOrganizationsForMarketplace("fdesfgsd");
  }

  @Test(expected = OperationNotPermittedException.class)
  public void testGetBannedSuppliersFromMarketplaceWithWrongRole() throws Exception {
    VOMarketplace marketplace =
        factory.createMarketplaceVO(supplier.getOrganizationId(), false, "globalMp");
    marketplace = createAndValidateMarketplace(marketplace);
    mpService_Operator.getBannedOrganizationsForMarketplace(marketplace.getMarketplaceId());
  ...
  public void testGetMarketplacesForOperator() throws Exception {
    VOMarketplace marketplaceForSupplier =
        factory.createMarketplaceVO(supplier.getOrganizationId(), false, "globalMp");
    marketplaceForSupplier = createAndValidateMarketplace(marketplaceForSupplier);

    VOMarketplace marketplaceForOperator =
        factory.createMarketplaceVO(PLATFORM_OPERATOR, false, "globalMp");
    marketplaceForOperator = createAndValidateMarketplace(marketplaceForOperator);

    List<VOMarketplace> marketplaces = mpService_Operator.getMarketplacesForOperator();
    assertNotNull(marketplaces);
    assertEquals(3, marketplaces.size()); // 2 created + Fujitsu Marketplace
  }

  @Test
  public void testGetMarketplacesForSupplier_ClosedMarketplace() throws Exception {
    VOMarketplace marketplaceForSupplier =
        factory.createMarketplaceVO(supplier.getOrganizationId(), false, "globalMp");
    marketplaceForSupplier = createAndValidateMarketplace(marketplaceForSupplier);
    ...
    List<VOMarketplace> marketplaces = mpService_Supplier.getMarketplacesForOrganization();
    assertNotNull(marketplaces);
    assertEquals(1, marketplaces.size());
  }

  @Test
  public void testGetMarketplacesForSupplier_OpenMarketplace() throws Exception {
  ...
  @Test(expected = ObjectNotFoundException.class)
  public void testGetMarketplacesForServicesWithInvalidService() throws Exception {
  ...
  public void getMarketplacesOwned() throws Exception {
    ...
    final IdentityService is =
        ServiceFactory.getDefault()
            .getIdentityService(setup.getSupplierUserKey(), WebserviceTestBase.DEFAULT_PASSWORD);
    is.grantUserRoles(is.getCurrentUserDetails(), Arrays.asList(UserRoleType.MARKETPLACE_OWNER));

    // use the marketplace service as supplier
    List<VOMarketplace> marketplaces = mpService_Supplier.getMarketplacesOwned();
    assertNotNull(marketplaces);
    assertEquals(1, marketplaces.size());
  ...
  public void testGetMarketplaceForSubscription() throws Exception {
    ...
    VOMarketplace marketplace2 =
        mpService_Supplier.getMarketplaceForSubscription(subscription.getKey(), "en");
    assertNotNull(marketplace2);
    assertEquals(marketplace.getKey(), marketplace2.getKey());
  }

  @Test(expected = ObjectNotFoundException.class)
  public void testGetMarketplaceForSubscriptionWithInvalidSubscription() throws Exception {
  ...
  public void testChangeOwnershipOfMarketplace() throws Exception {
    ...
    VOMarketplace marketplace = factory.createMarketplaceVO(PLATFORM_OPERATOR, false, "Mp");
    marketplace = createAndValidateMarketplace(marketplace);
    assertNotNull(marketplace);
    assertTrue(marketplace.getKey() > 0);
    assertEquals(0, marketplace.getVersion());
    ...
    assertNotNull(marketplace);
    assertTrue(marketplace.getKey() > 0);
    assertEquals(initialMpCount + 1, mpService_Operator.getMarketplacesOwned().size());

    // set supplier as owner for the previously created marketplace
    marketplace.setOwningOrganizationId(supplier.getOrganizationId());
    mpService_Operator.updateMarketplace(marketplace);
    marketplace = mpService_Operator.getMarketplaceById(marketplace.getMarketplaceId());
    assertEquals(supplier.getOrganizationId(), marketplace.getOwningOrganizationId());

    assertEquals(initialMpCount, mpService_Operator.getMarketplacesOwned().size());
  }

  @Test
  public void saveAndGetBrandingUrl() throws Exception {
    VOMarketplace marketplace =
        factory.createMarketplaceVO(supplier.getOrganizationId(), true, "BrandedMP");
    marketplace = createAndValidateMarketplace(marketplace);

    // set a valid branding URL
    mpService_Supplier.saveBrandingUrl(marketplace, brandingUrl);
    assertEquals(brandingUrl, mpService_Supplier.getBrandingUrl(marketplace.getMarketplaceId()));

    marketplace = mpService_Supplier.getMarketplaceById(marketplace.getMarketplaceId());

    // delete the branding URL
    mpService_Supplier.saveBrandingUrl(marketplace, null);
    assertNull(mpService_Supplier.getBrandingUrl(marketplace.getMarketplaceId()));
  }
  ...
  public void createMarketplace_AutomaticMPOwnerRole() throws Exception {
    ...
    Set<UserRoleType> roles =
        getUserDetails(setup.getSupplierUserKey(), setup.getSupplierUserId()).getUserRoles();
  ...
  public void updateMarketplace_AutomaticMPOwnerRole() throws Exception {
    ...
    VOMarketplace marketplace =
        factory.createMarketplaceVO(supplier.getOrganizationId(), true, "SomeName");
    marketplace = createAndValidateMarketplace(marketplace);
   ...
   * HELPER METHODS
   */
  private VOService createAndActivateFreeService(VOMarketplace marketplace) throws Exception {
    VOPriceModel priceModel = new VOPriceModel();
    priceModel.setType(PriceModelType.FREE_OF_CHARGE);
    VOService freeService = setup.createAndActivateService("Service", marketplace, priceModel);
  ...
  private void deleteAllMarketplaces() throws Exception {
    ...
    for (VOMarketplace voMarketplace : marketplaces) {
      if (!voMarketplace.getMarketplaceId().equals(setup.getGlobalMarketplaceId())) {
        mpService_Operator.deleteMarketplace(voMarketplace.getMarketplaceId());
      }
    }
  }

  private static void addSupplierToMarketplace(
      VOMarketplace marketplace,
      MarketplaceService mpService,
      String supplierId,
      int actualNumberOfSuppliers)
      throws Exception {

    List<VOOrganization> mpSuppliers =
        mpService.getOrganizationsForMarketplace(marketplace.getMarketplaceId());
    assertNotNull(mpSuppliers);
    assertEquals(actualNumberOfSuppliers, mpSuppliers.size());

    List<String> organizationIds = new LinkedList<String>();
    organizationIds.add(supplierId);
    mpService.addOrganizationsToMarketplace(organizationIds, marketplace.getMarketplaceId());

    mpSuppliers = mpService.getOrganizationsForMarketplace(marketplace.getMarketplaceId());
    assertNotNull(mpSuppliers);
    assertEquals(actualNumberOfSuppliers + 1, mpSuppliers.size());
  }

  private static void banSupplierFromMarketplace(
      VOMarketplace marketplace,
      MarketplaceService mpService,
      String supplierId,
      int actualNumberOfSuppliers)
    ...
    List<VOOrganization> mpSuppliers =
        mpService.getBannedOrganizationsForMarketplace(marketplace.getMarketplaceId());
    assertNotNull(mpSuppliers);
    assertEquals(actualNumberOfSuppliers, mpSuppliers.size());

    List<String> organizationIds = new LinkedList<String>();
    organizationIds.add(supplierId);
    mpService.banOrganizationsFromMarketplace(organizationIds, marketplace.getMarketplaceId());

    mpSuppliers = mpService.getBannedOrganizationsForMarketplace(marketplace.getMarketplaceId());
    assertNotNull(mpSuppliers);
    assertEquals(actualNumberOfSuppliers + 1, mpSuppliers.size());
  }
  ...
  private static void init() throws Exception {
    ...
    // use the marketplace service as supplier
    mpService_Supplier =
        ServiceFactory.getDefault().getMarketPlaceService(supplierKey, supplierPwd);

    ServiceProvisioningService provisioningService =
        ServiceFactory.getDefault().getServiceProvisioningService(supplierKey, supplierPwd);
  ...
  private VOMarketplace createAndValidateMarketplace(VOMarketplace transientMarketplace)
      throws Exception {
    VOMarketplace persistedMarketplace = mpService_Operator.createMarketplace(transientMarketplace);
    verifyPersistedMarketplace(transientMarketplace, persistedMarketplace);
    return persistedMarketplace;
  }

  private void verifyPersistedMarketplace(
      VOMarketplace transientMarketplace, VOMarketplace persistedMarketplace) {
    ...
    assertEquals(transientMarketplace.getName(), persistedMarketplace.getName());
    ...
    if (transientMarketplace.getOwningOrganizationId() != null) {
      assertEquals(
          transientMarketplace.getOwningOrganizationId(),
          persistedMarketplace.getOwningOrganizationId());

      if (transientMarketplace.getOwningOrganizationId().equals(supplier.getOrganizationId())) {
        assertEquals(supplier.getName(), persistedMarketplace.getOwningOrganizationName());
      }
    }
  }
  ...
  private void createMarketplaceAndPublishService(String mpOwnerId, boolean open) throws Exception {
    VOMarketplace marketplace;
    if (open) {
      marketplace = factory.createMarketplaceVO(mpOwnerId, true, "globalOpenMp");
    } else {
      marketplace = factory.createMarketplaceVO(mpOwnerId, false, "globalMp");
    }
    marketplace = createAndValidateMarketplace(marketplace);
  ...
  private void createMarketplaceAndPublishService(VOMarketplace marketplace) throws Exception {
    // create a new service without setting the marketplace
    VOService freeService = setup.createFreeService("Service");

    List<VOCatalogEntry> entries = factory.createCatalogEntryVO(marketplace, freeService);

    List<VOCatalogEntry> catalogEntries = mpService_Supplier.getMarketplacesForService(freeService);
    ...
    catalogEntries = mpService_Supplier.getMarketplacesForService(freeService);
    assertNotNull(catalogEntries);
    assertEquals(1, catalogEntries.size());
  ...
  private void deleteAndVerifyMarketplace(VOMarketplace marketplace) throws Exception {
    mpService_Operator.deleteMarketplace(marketplace.getMarketplaceId());
  ...
  private VOUserDetails getUserDetails(String adminUserKey, String userId) throws Exception {
    IdentityService idService =
        ServiceFactory.getDefault()
            .getIdentityService(adminUserKey, WebserviceTestBase.DEFAULT_PASSWORD);

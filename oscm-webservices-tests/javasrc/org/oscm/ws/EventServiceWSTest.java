...
public class EventServiceWSTest {
  ...
  public static final String TOO_LONG_STRING =
      "desription_123456789_123456789_123456789_123456789"
  ...
  public void before() throws Exception {
    eventService =
        ServiceFactory.getDefault()
            .getEventService(providerAdminKey, WebserviceTestBase.DEFAULT_PASSWORD);
  }

  /**
   * Creates a technology provider and imports a technical product. Also a supplier is created for
   * which a service is created and published.
   */
  private static void initTestData() throws Exception {
    ...
    accountService.addSuppliersForTechnicalService(
        techProduct, Collections.singletonList(supplier.getOrganizationId()));

    // SUPPLIER:
    initSupplierServices();
    marketplace = WebserviceTestBase.registerMarketplace(supplier.getOrganizationId(), "mp");
    enablePaymentType(accountService);
    registerMarketableService(serviceProvisioningService);
    WebserviceTestBase.publishToMarketplace(service, true, srvMarketplace, marketplace);
    service = serviceProvisioningService.activateService(service);
    VOSubscription subscription =
        WebserviceTestBase.createSubscription(
  ...
  private static void initProviderServices() throws Exception {
    accountService =
        ServiceFactory.getDefault()
            .getAccountService(providerAdminKey, WebserviceTestBase.DEFAULT_PASSWORD);
    serviceProvisioningService =
        ServiceFactory.getDefault()
            .getServiceProvisioningService(providerAdminKey, WebserviceTestBase.DEFAULT_PASSWORD);
  }
  ...
  private static void initSupplierServices() throws Exception {
    ...
    subscriptionService =
        ServiceFactory.getDefault()
            .getSubscriptionService(supplierAdminKey, WebserviceTestBase.DEFAULT_PASSWORD);
    accountService =
        ServiceFactory.getDefault()
  ...
  public static void registerProvider() throws Exception {
    VOUserDetails adminUser = factory.createUserVO("providerAdmin" + System.currentTimeMillis());
  ...
  public static void registerSupplier() throws Exception {
    VOUserDetails adminUser = factory.createUserVO("supplierAdmin" + System.currentTimeMillis());
    VOOrganization organization = factory.createOrganizationVO();
  ...
  private static void importTechnicalService(ServiceProvisioningService serviceProvisioningService)
    ...
    techProduct = WebserviceTestBase.createTechnicalService(tsxml, serviceProvisioningService);
  }

  private static void registerMarketableService(
      ServiceProvisioningService serviceProvisioningService) throws Exception {
    ...
    VOPriceModel priceModel = factory.createPriceModelVO(WebserviceTestBase.CURRENCY_EUR);
    priceModel.setOneTimeFee(BigDecimal.valueOf(100));
    priceModel.setPricePerPeriod(BigDecimal.valueOf(40));
    service = serviceProvisioningService.savePriceModel(serviceDetails, priceModel);
  }

  @Test(expected = SOAPFaultException.class)
  public void recordEventForInstance_AuthError() throws Exception {
    VOGatheredEvent event = factory.createVOGatheredEvent(System.currentTimeMillis(), "TEST");
    eventService =
        ServiceFactory.getDefault()
            .getEventService(supplierAdminKey, WebserviceTestBase.DEFAULT_PASSWORD);
    eventService.recordEventForInstance(techProduct.getTechnicalServiceId(), instanceId, event);
  }
  ...
  public void recordEventForInstance_NullInstanceId() throws Exception {
    VOGatheredEvent event = factory.createVOGatheredEvent(System.currentTimeMillis(), "TEST");
    eventService.recordEventForInstance(techProduct.getTechnicalServiceId(), null, event);
  }

  @Test(expected = SOAPFaultException.class)
  public void recordEventForInstance_NullEvent() throws Exception {
    eventService.recordEventForInstance(techProduct.getTechnicalServiceId(), instanceId, null);
  }
  ...
  public void recordEventForInstance_WrongEventId() throws Exception {
    VOGatheredEvent event = factory.createVOGatheredEvent(System.currentTimeMillis(), "TEST123");
    eventService.recordEventForInstance(techProduct.getTechnicalServiceId(), instanceId, event);
  }
  ...
  @Test(expected = ObjectNotFoundException.class)
  public void recordEventForSubscription_WrongSubscriptionKey() throws Exception {
    VOGatheredEvent event = factory.createVOGatheredEvent(System.currentTimeMillis(), "TEST");

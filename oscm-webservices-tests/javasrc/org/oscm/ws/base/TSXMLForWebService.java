 ...
 * <p>Author: weiser
 *
 * <p>Creation Date: 25.08.2010
 *
 * <p>Completion Time: 25.08.2010
 *
 * <p>*****************************************************************************
 */
...
public class TSXMLForWebService {
  ...
  private static final String XML_LAST_PART =
      "</" + TNS + "TechnicalService></" + TNS + "TechnicalServices>";
  private static final String XML_FIRST_PART =
      "<" + TNS + "TechnicalServices " + TARGET_NAMESPACE + ">";
  ...
  public static String createTSXMLWithTags(String technicalProductId) throws Exception {
    ...
    sb.append("baseUrl=\"" + baseUrl + "/" + MOCK + "/ProvisioningService?wsdl\" ");
    sb.append("build=\"\" ");
  ...
  public static String createTSXMLWithAllowingOnBehalfActingConnectable(String booleanValue)
      throws Exception {
  ...
  public static String createTSXMLWithModificationTypeAttribute(String serviceId) throws Exception {
    String baseUrl = WSProperties.load().getBaseUrl();
    String xml =
        "<"
            + TNS
  ...
  public static String createTSXMLWithModificationTypeAttribute() throws Exception {
   ...
   *
   * @param id the technical service ID
   * @return
   * @throws Exception
   */
  public static String createTSXMLWithOpsAndOpParams(String id) throws Exception {
    String baseUrl = WSProperties.load().getBaseUrl();
    String xml =
        "<"
            + TNS

...
public class TenantServiceBean implements TenantService {
  ...
  @EJB TenantServiceLocal tenantServiceLocal;
  ...
  public void updateTenant(VOTenant voTenant)
    ...
    tenantServiceLocal.saveTenant(TenantAssembler.updateTenantData(voTenant, tenantToUpdate));
  }

  @Override
  @RolesAllowed("PLATFORM_OPERATOR")
  public void removeTenant(VOTenant voTenant)

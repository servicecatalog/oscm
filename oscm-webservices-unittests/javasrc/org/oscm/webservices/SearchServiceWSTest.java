...
public class SearchServiceWSTest {
    ...
    private SearchServiceWS serviceWS;
    private SearchService serviceMock;
    private HttpServletRequest requestMock;

    @Before
    public void setup() {
        serviceMock = mock(SearchService.class);
        serviceWS = new SearchServiceWS();
    ...
    @Test
    public void testLogInjectionForSearchServiceWS() throws Exception {

        serviceWS.searchServices(null, null, null);
        serviceWS.getServicesByCriteria(null, null, null);

        verify(requestMock, times(2)).getRemoteAddr();

        verify(serviceMock, times(1)).searchServices(null, null, null);
        verify(serviceMock, times(1)).getServicesByCriteria(null, null, null);
    }

...
import org.oscm.internal.types.exception.beans.SubscriptionStateExceptionBean;
...
public class SubscriptionStateException extends SaaSApplicationException {
    ...
    public enum Reason {
        ...
        /**
         * Subscription is not in asynchronously updating process, the operation
         * cannot be performed.
         */
        NOT_IN_UPDATING,

        /**
         * Subscription is not in asynchronously upgrading process, the

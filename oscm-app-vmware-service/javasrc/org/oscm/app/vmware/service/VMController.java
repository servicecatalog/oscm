...
public class VMController implements APPlatformController {
	...
	public InstanceStatus getInstanceStatus(String instanceId, ProvisioningSettings settings)
		...
		try {
			...
			if (errorMessage.contains(Messages
					.get(ph.getLocale(), "error_finalize_provisioning", new Object[] { instanceId }).toString())) {
				throw new AbortException(Messages.getAll("error_finalize_provisioning", ph.getInstanceName()),
	...
	private void updateProvisioningSettings(VMPropertyHandler ph, StateMachine stateMachine, String instanceId)
		...
		case "ERROR":
			...
			if (errorMessage.contains(
					Messages.get(ph.getLocale(), "error_import_vm", new Object[] { instanceId }).toString())) {
				throw new AbortException(Messages.getAll("error_import_vm_not_found", ph.getInstanceName()),
	...
	public InstanceStatus executeServiceOperation(String userId, String instanceId, String transactionId,
		...
		try {
			...
			logger.warn("Failed to execute service operation " + operationId + " for instance " + instanceId
					+ " and user " + userId);

...
public class ManageTenantServiceBean implements ManageTenantService {
  private static final Log4jLogger logger = LoggerFactory.getLogger(ManageTenantServiceBean.class);

  @EJB TenantService tenantService;
  ...
  public void validateOrgUsersUniqnessInTenant(String orgId, long tenantKey)
    ...
    boolean duplicatedUserIdExists = tenantService.doOrgUsersExistInTenant(orgId, tenantKey);
  ...
  @Override
  public void validateOrgNameUniquenessInTenant(String orgName, String tenantId)
      throws ValidationException {
    final boolean duplicatedOrgNameExists =
        tenantService.doesOrgNameExistInTenant(orgName, tenantId);
    if (duplicatedOrgNameExists) {
      throw new ValidationException(
          ReasonEnum.ORGANIZATION_NAME_DUPLICATED, null, new Object[] {orgName});
    }
  }
}

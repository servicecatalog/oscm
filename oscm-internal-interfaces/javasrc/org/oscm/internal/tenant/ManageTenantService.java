...
public interface ManageTenantService {
   ...
   * @throws ConcurrentModificationException if version of tenant object is different than currently
   *     existing in DB.
   */
   ...
   * @throws TenantDeletionConstraintException if tenant is being used by organization or
   *     marketplace
   */
  void removeTenant(POTenant poTenant)
   ...
   */
  void validateOrgNameUniquenessInTenant(String orgName, String tenantId)

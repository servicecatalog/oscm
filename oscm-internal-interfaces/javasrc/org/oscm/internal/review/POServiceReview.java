...
/**
 * Presentation object of service review
 * 
 * @author Gao
 * 
 */
public class POServiceReview extends BasePO {

    private static final long serialVersionUID = 5135035034746452860L;
     ...
     */
    public POServiceReview(String title, int rating, String comment,
    ...
    /**
     * Returns the first name of the user who wrote this review, depending on
     * which information is available from the user's profile.
     * 
    ...
    /**
     * Sets the first name of the user writing this review, depending on which
     * information is available from the user's profile.
     * 
     * @param firstName
    ...
    /**
     * Returns the last name of the user who wrote this review, depending on
     * which information is available from the user's profile.
     * 
     * @return the lastName
     */
    ...
    /**
     * Sets the last name of the user writing this review, depending on which
     * information is available from the user's profile.
     * 
     * @param lastName
     *            the lastName to set

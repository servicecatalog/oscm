...
import org.oscm.billingservice.business.calculation.revenue.setup.BugAsyncSetup;
...
public class BugAsyncIT extends BillingIntegrationTestBase {

    private final BugAsyncSetup testSetup = new BugAsyncSetup();
    ...
    public void testBUG10974() throws Exception {
        // given subscription data for scenario
        try {
            testSetup.createBug10974();
        } catch (Exception e) {
            if (e instanceof SubscriptionStateException) {

                String msg = e.getMessage();
                assertTrue("Wrong SubscriptionStateException error message",
                        msg.endsWith("NOT_IN_UPDATING."));
    ...
    @Test(expected = SubscriptionStateException.class)
    public void testBUG10974_2() throws Exception {
        // given subscription data for scenario
        try {
            testSetup.createBug10974_2();
        } catch (Exception e) {
            if (e instanceof SubscriptionStateException) {

                String msg = e.getMessage();
                assertTrue("Wrong SubscriptionStateException error message",
                        msg.endsWith(" NOT_IN_UPGRADING."));

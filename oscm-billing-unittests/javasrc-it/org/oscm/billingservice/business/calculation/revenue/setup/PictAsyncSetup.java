 ...
 * @author baumann
 */
public class PictAsyncSetup extends IntegrationTestSetup {
    ...
    public void createPictScenario01() throws Exception {
        ...
        VOServiceDetails serviceDetails = serviceSetup
                .createPublishAndActivateMarketableService(
                        ...
                        technicalServiceAsync, supplMarketplace);
        ...
        BillingIntegrationTestBase
                .setDateFactoryInstance("2013-05-20 13:00:00");
        container.login(customerAdmin.getKey(), ROLE_ORGANIZATION_ADMIN);
    ...
    public void createPictScenario02() throws Exception {
        long setupStartTime = DateTimeHandling
                .calculateMillis("2013-06-02 20:00:00");
        BillingIntegrationTestBase.setDateFactoryInstance(setupStartTime);
        ...
        VOServiceDetails serviceFreeTempl = serviceSetup
                .createAndPublishMarketableService(supplierAdmin.getKey(),
                        "PICT_TEST_02", TestService.EXAMPLE_ASYNC,
        ...
        VOServiceDetails serviceProRataTempl = serviceSetup
                .createAndPublishMarketableService(supplierAdmin.getKey(),
                        "PICT_TEST_02_Upgrade", TestService.EXAMPLE_ASYNC,
        ...
        VOServiceDetails serviceProRataTempl2 = serviceSetup
                .createAndPublishMarketableService(supplierAdmin.getKey(),
                        "PICT_TEST_02_Upgrade2", TestService.EXAMPLE_ASYNC,
                        TestPriceModel.FREE, technicalServiceAsync,
                        supplMarketplace);
        ...
        long usageAsycUpgradeTime = DateTimeHandling
                .calculateMillis("2013-06-30 00:00:00");
        BillingIntegrationTestBase.setDateFactoryInstance(usageAsycUpgradeTime);
        container.login(customerAdmin.getKey(), ROLE_ORGANIZATION_ADMIN);
        VOSubscriptionDetails upgradedSubDetails = subscrSetup
        ...
        BillingIntegrationTestBase.setDateFactoryInstance(DateTimeHandling
                .calculateMillis("2013-07-03 13:00:00"));
        // container.login(customerAdmin.getKey(), ROLE_ORGANIZATION_ADMIN);
        ...
        // TODO: updated subscription id not in ds yet
        ...
        // note: role change and parameter change was at same time
        // changed role change (costs are 0 anyways) to a second later
        // TODO: check if this works

        // role change
        container.login(customerAdmin.getKey(), ROLE_ORGANIZATION_ADMIN);
        long roleChangeTime = DateTimeHandling
                .calculateMillis("2013-07-15 00:00:01");
        ...
        BillingIntegrationTestBase
                .setDateFactoryInstance("2013-07-21 00:00:00");
        container.login(customerAdmin.getKey(), ROLE_ORGANIZATION_ADMIN);
    ...
    public void createPictScenario03() throws Exception {
        BillingIntegrationTestBase
                .setDateFactoryInstance("2013-06-30 00:00:00");
        ...
        VOServiceDetails serviceDetailsTemp = serviceSetup
                .createAndPublishMarketableService(supplierAdmin.getKey(),
                        "PICT_TEST_03", TestService.EXAMPLE2_ASYNC,
    ...
    public void createPictScenario03_1() throws Exception {
        ...
        VOServiceDetails serviceDetailsTemp = serviceSetup
                .createAndPublishMarketableService(supplierAdmin.getKey(),
                        "PICT_TEST_03_1", TestService.EXAMPLE2_ASYNC,
                        TestPriceModel.FREE, example2TechService,
                        supplMarketplace);
        VOServiceDetails serviceDetails = serviceSetup
                .savePriceModelForCustomer(serviceDetailsTemp,
    ...
    public void createPictScenario03_2() throws Exception {
        ...
        VOServiceDetails serviceDetailsTemp = serviceSetup
                .createAndPublishMarketableService(supplierAdmin.getKey(),
                        "PICT_TEST_03_2", TestService.EXAMPLE2_ASYNC,
                        TestPriceModel.FREE, example2TechService,
                        supplMarketplace);
        VOServiceDetails serviceDetails = serviceSetup
                .savePriceModelForCustomer(serviceDetailsTemp,
    ...
    public void createPictScenario03_3() throws Exception {
        BillingIntegrationTestBase
                .setDateFactoryInstance("2013-02-28 00:00:00");
        ...
        VOServiceDetails serviceDetailsTemp = serviceSetup
                .createAndPublishMarketableService(supplierAdmin.getKey(),
                        "PICT_TEST_03_3", TestService.EXAMPLE2_ASYNC,
                        TestPriceModel.FREE, example2TechService,
                        supplMarketplace);
        VOServiceDetails serviceDetails = serviceSetup
                .savePriceModelForCustomer(serviceDetailsTemp,
    ...
    public void createPictScenario03_4() throws Exception {
        BillingIntegrationTestBase
                .setDateFactoryInstance("2013-09-30 00:00:00");
        ...
        VOServiceDetails serviceDetailsTemp = serviceSetup
                .createAndPublishMarketableService(supplierAdmin.getKey(),
                        "PICT_TEST_03_4", TestService.EXAMPLE2_ASYNC,
                        TestPriceModel.FREE, example2TechService,
                        supplMarketplace);
        VOServiceDetails serviceDetails = serviceSetup
                .savePriceModelForCustomer(serviceDetailsTemp,
    ...
    public void createPictScenario03_5() throws Exception {
        ...
        VOServiceDetails serviceDetailsTemp = serviceSetup
                .createAndPublishMarketableService(supplierAdmin.getKey(),
                        "PICT_TEST_03_5", TestService.EXAMPLE2_ASYNC,
                        TestPriceModel.FREE, example2TechService,
                        supplMarketplace);
        VOServiceDetails serviceDetails = serviceSetup
                .savePriceModelForCustomer(serviceDetailsTemp,
        ...
        userAssignedTime = DateTimeHandling
                .calculateMillis("2013-03-22 10:15:00");
        BillingIntegrationTestBase.setDateFactoryInstance(userAssignedTime);
        // at same time as role change, change parameter value too.
        container.login(customerAdmin.getKey(), ROLE_ORGANIZATION_ADMIN);
        subDetails = subscrSetup.modifyParameterForSubscription(subDetails,
                userAssignedTime, "PERIOD", DateTimeHandling.daysToMillis(200)
                        + "");
        // ASYNC note: role, par change at same time, complete at same time TODO
        userAssignedTime = DateTimeHandling
                .calculateMillis("2013-03-22 10:20:00");
        BillingIntegrationTestBase.setDateFactoryInstance(userAssignedTime);
        subDetails = subscrSetup.completeAsyncModifySubscription(
    ...
    public void createPictScenario04() throws Exception {
        ...
        // ASYNC
        BillingIntegrationTestBase.setDateFactoryInstance(DateTimeHandling
                .calculateMillis("2013-03-06 00:00:00"));
        subDetails = subscrSetup.completeAsyncModifySubscription(
                basicSetup.getSupplierAdminKey(), customerAdmin, subDetails);
        ...
        container.login(customerAdmin.getKey(), ROLE_ORGANIZATION_ADMIN);
        BillingIntegrationTestBase.setDateFactoryInstance(DateTimeHandling
                .calculateMillis("2013-03-10 00:00:00"));
        VOSubscriptionDetails upgradedSubDetails = subscrSetup
        ...
        upgradedSubDetails = subscrSetup.modifyParameterForSubscription(
                upgradedSubDetails,
                DateTimeHandling.calculateMillis("2013-03-11 12:00:00"),
                "PERIOD", DateTimeHandling.daysToMillis(110) + "");
        // ASYNC
        BillingIntegrationTestBase.setDateFactoryInstance(DateTimeHandling
                .calculateMillis("2013-03-12 00:00:00"));
        upgradedSubDetails = subscrSetup.completeAsyncModifySubscription(
                basicSetup.getSupplierAdminKey(), customerAdmin,
                upgradedSubDetails);

        BillingIntegrationTestBase.setDateFactoryInstance(DateTimeHandling
                .calculateMillis("2013-03-13 00:00:00"));
        VOSubscriptionDetails upgradedSubDetailsOld = upgradedSubDetails;
        ...
        upgradedSubDetails2 = subscrSetup.modifyParameterForSubscription(
                upgradedSubDetails2,
                DateTimeHandling.calculateMillis("2013-03-23 00:00:00"),
                "PERIOD", DateTimeHandling.daysToMillis(90) + "");
        // ASYNC
        BillingIntegrationTestBase.setDateFactoryInstance(DateTimeHandling
                .calculateMillis("2013-03-24 00:00:00"));
    ...
    public void createPictScenario04_1() throws Exception {
        ...
        BillingIntegrationTestBase.setDateFactoryInstance(DateTimeHandling
                .calculateMillis("2013-03-14 00:00:00"));
        // TODO subscription id is not changed yet
        upgradedSubDetails = subscrSetup.completeAsyncModifySubscription(
                basicSetup.getSupplierAdminKey(), customerAdmin,
                upgradedSubDetailsOld);
    ...
    public void createPictScenario05() throws Exception {
        BillingIntegrationTestBase.setDateFactoryInstance(DateTimeHandling
                .calculateMillis("2013-01-28 10:00:00"));
        ...
        container.login(customerAdmin.getKey(), ROLE_ORGANIZATION_ADMIN);
        BillingIntegrationTestBase.setDateFactoryInstance(DateTimeHandling
                .calculateMillis("2013-02-01 09:00:00"));
        VOSubscriptionDetails upgradedSubDetails = subscrSetup
        ...
        // change subscriptionID
        BillingIntegrationTestBase.setDateFactoryInstance(DateTimeHandling
                .calculateMillis("2013-02-01 10:05:00"));
        container.login(customerAdmin.getKey(), ROLE_ORGANIZATION_ADMIN);
        VOSubscriptionDetails upgradedSubDetailsOld = upgradedSubDetails;
        ...
        container.login(customerAdmin.getKey(), ROLE_ORGANIZATION_ADMIN);
        BillingIntegrationTestBase.setDateFactoryInstance(DateTimeHandling
                .calculateMillis("2013-02-02 00:00:00"));
        VOSubscriptionDetails upgradedSubDetails2 = subscrSetup
        ...
        upgradedSubDetails2 = subscrSetup.modifyParameterForSubscription(
                upgradedSubDetails2,
                DateTimeHandling.calculateMillis("2013-02-03 01:00:00"),
                "HAS_OPTIONS", "1");
        // ASYNC
        BillingIntegrationTestBase.setDateFactoryInstance(DateTimeHandling
                .calculateMillis("2013-02-03 02:00:00"));
        upgradedSubDetails2 = subscrSetup.completeAsyncModifySubscription(
                basicSetup.getSupplierAdminKey(), customerAdmin,
                upgradedSubDetails2);
    ...
    public void createPictScenario05_1() throws Exception {
        BillingIntegrationTestBase.setDateFactoryInstance(DateTimeHandling
                .calculateMillis("2013-01-29 10:00:00"));
        ...
        container.login(customerAdmin.getKey(), ROLE_ORGANIZATION_ADMIN);
        BillingIntegrationTestBase.setDateFactoryInstance(DateTimeHandling
                .calculateMillis("2013-01-30 11:00:00"));
        VOSubscriptionDetails upgradedSubDetails = subscrSetup
                .upgradeSubscription(subDetails, proRataService);
        // ASYNC
        BillingIntegrationTestBase.setDateFactoryInstance(DateTimeHandling
        ...
        BillingIntegrationTestBase.setDateFactoryInstance(DateTimeHandling
                .calculateMillis("2013-02-01 10:3" + "0:00"));
        container.login(customerAdmin.getKey(), ROLE_ORGANIZATION_ADMIN);
        VOSubscriptionDetails upgradedSubDetailsOld = upgradedSubDetails;
        ...
        // TODO: subscription id is still the old one
        upgradedSubDetails = subscrSetup.completeAsyncModifySubscription(
                basicSetup.getSupplierAdminKey(), customerAdmin,
                upgradedSubDetailsOld);
    ...
    public void createPictScenario06() throws Exception {
        BillingIntegrationTestBase.setDateFactoryInstance(DateTimeHandling
                .calculateMillis("2013-10-22 10:00:00"));
        ...
        VOServiceDetails serviceUnitTempl = serviceSetup
                .createAndPublishMarketableService(supplierAdmin.getKey(),
                        "PICT_TEST_06", TestService.EXAMPLE2_ASYNC,
                        TestPriceModel.FREE, technicalServiceAsync,
                        supplierMarketplace);
        VOServiceDetails serviceDetails = serviceSetup
        ...
        VOServiceDetails serviceProRataTempl = serviceSetup
                .createAndPublishMarketableService(supplierAdmin.getKey(),
                        "PICT_TEST_06_Upgrade", TestService.EXAMPLE2_ASYNC,
                        TestPriceModel.FREE, technicalServiceAsync,
                        supplierMarketplace);
        VOServiceDetails serviceProRata = serviceSetup
                .savePriceModelForCustomer(serviceProRataTempl,
        ...
        // ASYNC
        BillingIntegrationTestBase.setDateFactoryInstance(DateTimeHandling
                .calculateMillis("2013-10-23 10:00:00"));
        subDetails = subscrSetup.completeAsyncSubscription(
                basicSetup.getSupplierAdminKey(), customerAdmin, subDetails);
        ...
        container.login(customerAdmin.getKey(), ROLE_ORGANIZATION_ADMIN);
        BillingIntegrationTestBase.setDateFactoryInstance(DateTimeHandling
                .calculateMillis("2013-10-26 09:30:00"));
        VOSubscriptionDetails upgradedSubDetails = subscrSetup
                .upgradeSubscription(subDetails, serviceProRata);
        // ASYNC
        BillingIntegrationTestBase.setDateFactoryInstance(DateTimeHandling
    ...
    public void createPictScenario07() throws Exception {
        ...
        VOServiceDetails serviceUnitTempl = serviceSetup
                .createAndPublishMarketableService(supplierAdmin.getKey(),
                        "PICT_TEST_07", TestService.EXAMPLE2_ASYNC,
                        TestPriceModel.FREE, technicalServiceAsync,
                        supplierMarketplace);
        VOServiceDetails serviceDetails = serviceSetup
                .savePriceModelForCustomer(serviceUnitTempl,
        ...
        VOServiceDetails serviceFreeTempl = serviceSetup
                .createAndPublishMarketableService(supplierAdmin.getKey(),
                        "PICT_TEST_07_Upgrade", TestService.EXAMPLE2_ASYNC,
        ...
        container.login(customerAdmin.getKey(), ROLE_ORGANIZATION_ADMIN);
        subDetails = subscrSetup.modifyParameterForSubscription(subDetails,
                DateTimeHandling.calculateMillis("2013-08-07 12:00:00"),
                "LONG_NUMBER", "500");
        // ASYNC
        BillingIntegrationTestBase.setDateFactoryInstance(DateTimeHandling
                .calculateMillis("2013-08-08 12:00:00"));
        subDetails = subscrSetup.completeAsyncModifySubscription(
                basicSetup.getSupplierAdminKey(), customerAdmin, subDetails);
    ...
    public void createPictScenario08() throws Exception {
        BillingIntegrationTestBase.setDateFactoryInstance(DateTimeHandling
                .calculateMillis("2013-06-30 09:00:00"));
        ...
        container.login(customerAdmin.getKey(), ROLE_ORGANIZATION_ADMIN);
        BillingIntegrationTestBase.setDateFactoryInstance(DateTimeHandling
                .calculateMillis("2013-07-13 12:00:00"));
        VOSubscriptionDetails upgradedSubDetails = subscrSetup
                .upgradeSubscription(subDetails, proRataService);
        // ASYNC
        BillingIntegrationTestBase.setDateFactoryInstance(DateTimeHandling
    ...
    public void createPictScenario09() throws Exception {
        ...
        // change subscriptionID
        BillingIntegrationTestBase.setDateFactoryInstance(DateTimeHandling
                .calculateMillis("2013-03-10 13:00:00"));
        container.login(customerAdmin.getKey(), ROLE_ORGANIZATION_ADMIN);
        ...
        // TODO: subscription id is still the old one
        subDetails = subscrSetup.completeAsyncModifySubscription(
                supplierAdmin.getKey(), customerAdmin, upgradedSubDetailsOld);
        ...
        BillingIntegrationTestBase.setDateFactoryInstance(DateTimeHandling
                .calculateMillis("2013-03-31 11:59:58"));
        container.login(customerAdmin.getKey(), ROLE_ORGANIZATION_ADMIN);
        VOSubscriptionDetails upgradedSubDetails = subscrSetup
                .upgradeSubscription(subDetails, serviceFreeDetails);
        // ASYNC
        ...
        BillingIntegrationTestBase.setDateFactoryInstance(DateTimeHandling
                .calculateMillis("2013-03-31 14:00:00"));
        container.login(customerAdmin.getKey(), ROLE_ORGANIZATION_ADMIN);
        VOSubscriptionDetails upgradedSubDetails2 = subscrSetup
    ...
    public void createPictScenario10() throws Exception {
        ...
        VOServiceDetails freeTemplate = serviceSetup
                .createAndPublishMarketableService(supplierAdmin.getKey(),
                        "PICT10_FREE", TestService.EXAMPLE2_ASYNC,
                        TestPriceModel.FREE, example2TechService,
                        supplierMarketplace);
        ...
        upgradedSubDetails = subscrSetup.modifyParameterForSubscription(
                upgradedSubDetails,
                DateTimeHandling.calculateMillis("2013-07-14 09:00:00"),
                "BOOLEAN_PARAMETER", "true");
        // ASYNC
        BillingIntegrationTestBase.setDateFactoryInstance(DateTimeHandling
                .calculateMillis("2013-07-14 10:00:00"));
        upgradedSubDetails = subscrSetup.completeAsyncModifySubscription(
                supplierAdmin.getKey(), customerAdmin, upgradedSubDetails);
        ...
        container.login(customerAdmin.getKey(), ROLE_ORGANIZATION_ADMIN);
        BillingIntegrationTestBase.setDateFactoryInstance(DateTimeHandling
                .calculateMillis("2013-08-13 00:00:00"));
        VOSubscriptionDetails upgradedSubDetails2 = subscrSetup
    ...
    public void createPictScenario11() throws Exception {
        ...
        VOServiceDetails unitServTemplate = serviceSetup
                .createAndPublishMarketableService(supplierAdmin.getKey(),
                        "PICT11_UNIT_WEEK_SERVICE", TestService.EXAMPLE2_ASYNC,
                        TestPriceModel.FREE, example2TechService,
                        supplierMarketplace);
        VOServiceDetails serviceUnitDetails = serviceSetup
        ...
        VOServiceDetails freeTemplate = serviceSetup
                .createAndPublishMarketableService(supplierAdmin.getKey(),
                        "PICT11_FREE", TestService.EXAMPLE2_ASYNC,
        ...
        container.login(customerAdmin.getKey(), ROLE_ORGANIZATION_ADMIN);
        subDetails = subscrSetup.modifyParameterForSubscription(subDetails,
                DateTimeHandling.calculateMillis("2013-08-01 00:30:00"),
                "BOOLEAN_PARAMETER", "true");

        // ASYNC for parameter upd
        BillingIntegrationTestBase.setDateFactoryInstance(DateTimeHandling
        ...
        // change subscriptionID
        BillingIntegrationTestBase.setDateFactoryInstance(DateTimeHandling
                .calculateMillis("2013-08-01 01:00:01"));
        container.login(customerAdmin.getKey(), ROLE_ORGANIZATION_ADMIN);
        VOSubscriptionDetails subDetailsOld = subDetails;
        subDetails.setSubscriptionId("PICT_TEST_11" + "_SubID2");
        subDetails = subscrSetup.modifySubscription(subDetails, null);
        // ASYNC for subscriptionId upd (one second later now) because par
        // update was at same time
        BillingIntegrationTestBase.setDateFactoryInstance(DateTimeHandling
                .calculateMillis("2013-08-01 01:00:01"));
        subDetails = subscrSetup.completeAsyncModifySubscription(
                supplierAdmin.getKey(), customerAdmin, subDetailsOld);
        ...
        container.login(customerAdmin.getKey(), ROLE_ORGANIZATION_ADMIN);
        subDetails = subscrSetup.modifyParameterForSubscription(subDetails,
                DateTimeHandling.calculateMillis("2013-08-12 15:00:00"),
        ...
        container.login(customerAdmin.getKey(), ROLE_ORGANIZATION_ADMIN);
        subDetails = subscrSetup.modifyParameterForSubscription(subDetails,
                DateTimeHandling.calculateMillis("2013-08-13 12:00:00"),
                "BOOLEAN_PARAMETER", "true");
        // ASYNC
        BillingIntegrationTestBase.setDateFactoryInstance(DateTimeHandling
                .calculateMillis("2013-08-14 00:00:00"));
        ...
        container.login(customerAdmin.getKey(), ROLE_ORGANIZATION_ADMIN);
        BillingIntegrationTestBase.setDateFactoryInstance(DateTimeHandling
                .calculateMillis("2013-08-14 23:00:00"));
        VOSubscriptionDetails upgradedSubDetails = subscrSetup
                .upgradeSubscription(subDetails, serviceFreeDetails);
        // ASYNC
        BillingIntegrationTestBase.setDateFactoryInstance(DateTimeHandling
        ...
        container.login(customerAdmin.getKey(), ROLE_ORGANIZATION_ADMIN);
        BillingIntegrationTestBase.setDateFactoryInstance(DateTimeHandling
                .calculateMillis("2013-08-19 00:00:00"));
        VOSubscriptionDetails upgradedSubDetails2 = subscrSetup
                .upgradeSubscription(upgradedSubDetails, serviceUnitDetails2);
        // ASYNC
        BillingIntegrationTestBase.setDateFactoryInstance(DateTimeHandling
    ...
    public void createPictScenario12() throws Exception {
        ...
        BillingIntegrationTestBase.setDateFactoryInstance(DateTimeHandling
                .calculateMillis("2013-08-05 00:00:00"));
        ...
        container.login(customerAdmin.getKey(), ROLE_ORGANIZATION_ADMIN);
        subDetails = subscrSetup.modifyParameterForSubscription(subDetails,
                DateTimeHandling.calculateMillis("2013-08-09 00:00:00"),
                "BOOLEAN_PARAMETER", "true");
        // ASYNC
        BillingIntegrationTestBase.setDateFactoryInstance(DateTimeHandling
                .calculateMillis("2013-08-10 00:00:00"));
        subDetails = subscrSetup.completeAsyncModifySubscription(
                supplierAdmin.getKey(), customerAdmin, subDetails);
        ...
        container.login(customerAdmin.getKey(), ROLE_ORGANIZATION_ADMIN);
        subDetails = subscrSetup.modifyParameterForSubscription(subDetails,
                DateTimeHandling.calculateMillis("2013-09-06 00:00:00"),
                "BOOLEAN_PARAMETER", "false");
        // ASYNC
        BillingIntegrationTestBase.setDateFactoryInstance(DateTimeHandling
                .calculateMillis("2013-09-07 00:00:00"));
        subDetails = subscrSetup.completeAsyncModifySubscription(
                supplierAdmin.getKey(), customerAdmin, subDetails);
    ...
    public void createPictScenario13() throws Exception {
        ...
        BillingIntegrationTestBase.setDateFactoryInstance(DateTimeHandling
                .calculateMillis("2013-10-02 00:00:00"));
        ...
        VOServiceDetails unitServTemplate = serviceSetup
                .createAndPublishMarketableService(supplierAdmin.getKey(),
                        "PICT13_UNIT_HOUR_SERVICE", TestService.EXAMPLE2_ASYNC,
                        TestPriceModel.FREE, example2TechService,
                        supplierMarketplace);
        VOServiceDetails serviceUnitDetails = serviceSetup
                .savePriceModelForCustomer(unitServTemplate,
        ...
        VOServiceDetails freeTemplate = serviceSetup
                .createAndPublishMarketableService(supplierAdmin.getKey(),
                        "PICT13_FREE", TestService.EXAMPLE2_ASYNC,
        ...
        container.login(customerAdmin.getKey(), ROLE_ORGANIZATION_ADMIN);
        subDetails = subscrSetup.modifyParameterForSubscription(subDetails,
                DateTimeHandling.calculateMillis("2013-10-04 10:10:00"),
                "MAX_FOLDER_NUMBER", "5");
        // ASYNC note: role change at same time as par change (moved it below)
        BillingIntegrationTestBase.setDateFactoryInstance(DateTimeHandling
        ...
        container.login(customerAdmin.getKey(), ROLE_ORGANIZATION_ADMIN);
        BillingIntegrationTestBase.setDateFactoryInstance(DateTimeHandling
                .calculateMillis("2013-10-29 00:00:00"));
        VOSubscriptionDetails upgradedSubDetails = subscrSetup
                .upgradeSubscription(subDetails, serviceFreeDetails);
        // ASYNC
        BillingIntegrationTestBase.setDateFactoryInstance(DateTimeHandling
    ...
    public void createPictScenario13_1() throws Exception {
        ...
        VOServiceDetails freeTemplate = serviceSetup
                .createAndPublishMarketableService(supplierAdmin.getKey(),
                        "PICT13_1_FREE", TestService.EXAMPLE2_ASYNC,
                        TestPriceModel.EXAMPLE_PICT13_UNIT_HOUR,
                        example2TechService, supplierMarketplace);
        VOServiceDetails serviceFreeDetails = serviceSetup
                .savePriceModelForCustomer(freeTemplate, TestPriceModel.FREE,
        ...
        container.login(customerAdmin.getKey(), ROLE_ORGANIZATION_ADMIN);
        subDetails = subscrSetup.modifyParameterForSubscription(subDetails,
                DateTimeHandling.calculateMillis("2013-10-04 09:00:00"),
                "MAX_FOLDER_NUMBER", "5");
        // ASYNC note: role upd (moved it below) is at same time as par upd
        BillingIntegrationTestBase.setDateFactoryInstance(DateTimeHandling

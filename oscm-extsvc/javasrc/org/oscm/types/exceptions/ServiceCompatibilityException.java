...
import org.oscm.types.exceptions.beans.ServiceCompatibilityExceptionBean;
 ...
 * 
 */
@WebFault(name = "ServiceCompatibilityException", targetNamespace = "http://oscm.org/xsd")
public class ServiceCompatibilityException extends SaaSApplicationException {
    ...
    private ServiceCompatibilityExceptionBean bean = new ServiceCompatibilityExceptionBean();

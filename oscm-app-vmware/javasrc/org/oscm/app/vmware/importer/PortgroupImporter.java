...
public class PortgroupImporter implements Importer{
    ...
    private void save(Portgroup portgroup) throws Exception {
        String query = "INSERT INTO portgroup (tkey, uuid, name, distributedvirtualswitch_cluster_fk) VALUES (DEFAULT,?,?,?)";
        int dvsKey = this.getDVSKey(portgroup.vCenter, portgroup.datacenter, portgroup.cluster, portgroup.distributedVirtualSwitch);
    ...
    private int getDVSKey(String vCenter, String datacenter, String cluster, String distributedvirtualswitch) throws Exception {
        String query = ""

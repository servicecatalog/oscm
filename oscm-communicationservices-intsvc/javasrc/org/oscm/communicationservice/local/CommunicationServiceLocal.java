 ...
 *
 * <p>The service uses the configuration service to obtain the mail server address and the reply
 * mail address.
 *
...
public interface CommunicationServiceLocal {
   ...
   *
   * @param type The email content type.
   * @param params Parameters for the email content text.
   * @param marketplace the marketplace to get customized texts from - can be <code>null</code>
   * @param recipients The platform users the mail will be sent to.
   * @return mail status of every sended mail encapsulated in a separate instance
   */
   ...
   *
   * @param recipient The platform user the mail will be sent to.
   * @param type The email content type.
   * @param params Parameters for the email content text.
   * @param marketplace the marketplace to get customized texts from - can be <code>null</code>
   * @throws MailOperationException Thrown in case the mail cannot be initialized or sent.
   */
   ...
   *
   * @param emailAddress The address to which the mail will be send to.
   * @param type Mail type.
   * @param params Mail parameters,
   * @param marketplace Marketpalce of subscription,
   ...
   * @param params Mail parameters,
   * @param marketplace The marketplace to get customized texts from - can be <code>null</code>
   * @param organizations The organizations the mail will be sent to.
   * @return mail status of every sended mail encapsulated in a separate instance
   */
   ...
   * @throws MailOperationException Thrown if an UnsupportedEncodingException occurs during the URL
   *     construction.
   */
  ...
  /**
   * Sends an email to the given address for given target user.
   *
   * @param emailAddress where the mail will be sent to.
   * @param targetUser the target user addressed in this email
   * @param type The email content type.
   * @param params Parameters for the email content text.
   * @param marketplace the marketplace to get customized texts from - can be <code>null</code>
   * @throws MailOperationException Thrown in case the mail cannot be initialized or sent.
  ...
  /**
   * if the OSCM mail mock service is used.
   *
   * <p>
   *
   * @return <code>true</code> if the mail mock service is used, otherwise <code>false</code>.
   */

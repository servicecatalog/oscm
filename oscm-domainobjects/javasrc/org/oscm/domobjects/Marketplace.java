...
/**
 * A marketplace represents an 'area' where services can be offered be suppliers and subscribed by
 * customers.
 */
...
@NamedQueries({
  @NamedQuery(
      name = "Marketplace.findByBusinessKey",
      query =
          "SELECT mp FROM Marketplace mp WHERE mp.dataContainer.marketplaceId = :marketplaceId"),
  @NamedQuery(name = "Marketplace.getAll", query = "SELECT mp FROM Marketplace mp"),
  @NamedQuery(
      name = "Marketplace.getAllAccessible",
      query =
          "SELECT mp FROM Marketplace mp WHERE mp"
  ...
  @NamedQuery(
      name = "Marketplace.getByOwner",
      query =
          "SELECT mp FROM Marketplace mp, Organization o WHERE mp.organization = o AND o.dataContainer.organizationId=:organizationId"),
  @NamedQuery(
      name = "Marketplace.findByService",
      query =
          "SELECT mp FROM Marketplace mp, CatalogEntry ce WHERE ce.marketplace = mp AND ce.product=:service"),
  @NamedQuery(
      name = "Marketplace.findMarketplacesForPublishingForOrg",
      query =
          "SELECT mp FROM Marketplace mp "
              + "WHERE ( (mp.dataContainer.open = FALSE AND EXISTS (SELECT mto FROM MarketplaceToOrganization mto WHERE mp.key = mto.marketplace_tkey "
  ...
  @NamedQuery(
      name = "Marketplace.getAllForTenant",
      query = "SELECT mp FROM Marketplace mp WHERE mp" + ".tenant = :tenant"),
  @NamedQuery(
      name = "Marketplace.getAllForDefaultTenant",
      query = "SELECT mp FROM Marketplace mp WHERE mp" + ".tenant is null")
})
@Entity

...
@NamedQueries({
        ...
        @NamedQuery(name = "Organization.getOrganizationIdentifiersByRole", query = "SELECT DISTINCT o.dataContainer.organizationId, o.dataContainer.name FROM Organization o, OrganizationToRole o2r, OrganizationRole r WHERE o = o2r.organization and o2r.organizationRole = r and r.dataContainer.roleName IN (:organizationRoleTypes)"),

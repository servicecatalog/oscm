...
@NamedQueries({
        ...
        @NamedQuery(name = "Organization.getOrganizationIdenitfiersByRole", query = "SELECT DISTINCT o.dataContainer.organizationId, o.dataContainer.name FROM Organization o, OrganizationToRole o2r, OrganizationRole r WHERE o = o2r.organization and o2r.organizationRole = r and r.dataContainer.roleName IN (:organizationRoleTypes)"),
        ...
        @NamedQuery(name = "Organization.findOrganizationsByName", query = "SELECT o FROM Organization o where o.dataContainer.name like :name AND ((o.tenant IS NULL AND :tenantId IS NULL) OR EXISTS (SELECT t FROM Tenant t WHERE t=o.tenant AND t.dataContainer.tenantId = :tenantId))"),

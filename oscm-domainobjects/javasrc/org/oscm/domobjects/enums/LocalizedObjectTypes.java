...
/**
 * This enumeration lists all information within the domain objects that is supported in several
 * languages (i18n).
 *
...
public enum LocalizedObjectTypes {
  ...
  REPORT_DESC(InformationSource.DATABASE_AND_RESOURCE_BUNDLE, "PlatformLocalizations"),

  /** Identifies the description of a parameter definition. */
  PARAMETER_DEF_DESC(InformationSource.DATABASE_AND_RESOURCE_BUNDLE, "PlatformLocalizations"),
  ...
  PAYMENT_TYPE_NAME(InformationSource.DATABASE_AND_RESOURCE_BUNDLE, "PlatformLocalizations"),

  /** Defines the content of the stage of the landing page. */
  MARKETPLACE_STAGE(InformationSource.DATABASE),

  /** Defines the content of the mobile stage of the landing page. */
  MARKETPLACE_MOBILE_STAGE(InformationSource.DATABASE),
  ...
  /**
   * Reseller can overwrite the price model license specified by the supplier organization of a
   * service. This tag indicates such a refinement.
   */
  ...
  /**
   * Identifies the exception properties. These messages can be overwritten by the user for each
   * marketplace independently and for the platform in general.
   */
  ...
  /**
   * Constructor that accepts the source of information, the concrete source location if required
   * and a default value. if the source is {@link InformationSource#DATABASE} the sourceLocation can
   * be left as <code>null</code>.
   *
   * @param source The source of the information.
   * @param sourceLocation The concrete location of the information source, e.g. a bundle name.
   * @param defaultValue The default value if no translation can be found.
   */
  private LocalizedObjectTypes(
      InformationSource source, String sourceLocation, String defaultValue) {
    this.source = source;
  ...
  /**
   * Constructor that accepts the source of information and the concrete source name if required. if
   * the source is {@link InformationSource#DATABASE} the sourceLocation can be left as <code>null
   * </code>.
   *
   * @param source The source of the information.
   * @param sourceLocation The concrete location of the information source, e.g. a bundle name.
  ...
  /**
   * Constructor that sets the sourceLocation to null, refer to {@link
   * #LocalizedObjectTypes(InformationSource, String)}.
   *
   * @param source The source of the information.
   */
   ...
   *
   * @param type The localized object type to check
   * @return
   */
  public boolean isProductRelated() {
    return this == PRODUCT_MARKETING_NAME
        || this == PRODUCT_MARKETING_DESC

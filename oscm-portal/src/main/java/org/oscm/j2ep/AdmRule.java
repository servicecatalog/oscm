...
public class AdmRule extends BaseRule {
   ...
   *
   * @param rewriteTo the rewrite string containing the target context path of the
   *                  subscription.
   */
   ...
   * Called from the server after the instantiation of a new rule.
   *
   * @param revertPattern the revert pattern containing the target context path of the
   *                      subscription.
   */

...
-    `.\basic\_colors.scss`: defines the theme colors as CSS variables. Refer to the section about [theme variables modification](#mts) for more details.
...
### Modification of theme variables in the source files {#mts}

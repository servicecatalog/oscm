...
public class AuthenticationSettings {
  ...
  public AuthenticationSettings(TenantService tenantService, ConfigurationService cfgService) {
    ...
    authenticationMode = getConfigurationSetting(cfgService, ConfigurationKey.AUTH_MODE);
    this.cfgService = cfgService;
  }

  String getConfigurationSetting(ConfigurationService cfgService, ConfigurationKey key) {
    VOConfigurationSetting voConfSetting =
        cfgService.getVOConfigurationSetting(key, Configuration.GLOBAL_CONTEXT);
    String setting = null;
  ...
  /**
   * The URL must be set to lower case, because in the configuration settings, it can be given with
   * upper case and matching will not work.
   */
  ...
  public void init(String tenantID)
    ...
    signingKeystorePass =
        getConfigurationSetting(cfgService, ConfigurationKey.SSO_SIGNING_KEYSTORE_PASS);

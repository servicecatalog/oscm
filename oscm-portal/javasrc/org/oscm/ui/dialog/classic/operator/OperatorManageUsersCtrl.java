...
public class OperatorManageUsersCtrl extends BaseOperatorBean implements Serializable {
  ...
  long getMaxRegisteredUsersCount() {
    if (maxRegisteredUsersCount == null) {
      VOConfigurationSetting configurationSetting =
  ...
  public boolean isExceedMaxNumberOfUsers() {
    if (model.getNumberOfRegisteredUsers() <= model.getMaxNumberOfRegisteredUsers()) return false;
    else {
      return true;
    }
  }
  ...
  public void updateSelectedUser()
      throws OperationNotPermittedException, ObjectNotFoundException, OrganizationRemovedException {
  ...
  public String importUsers() {
    ...
    try {
      ...
      getUserService().importUsers(buffer, getSelectedOrganization(), getSelectedMarketplace());
      model.resetToken();
      ui.handle("info.user.importStarted.updateHint", model.getUserImport().getSubmittedFileName());

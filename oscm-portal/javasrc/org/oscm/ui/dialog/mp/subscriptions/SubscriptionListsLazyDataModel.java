...
public class SubscriptionListsLazyDataModel extends RichLazyDataModel<POSubscriptionForList> {
  ...
  private static final Log4jLogger logger =
      LoggerFactory.getLogger(SubscriptionListsLazyDataModel.class);
  ...
  @Override
  public List<POSubscriptionForList> getDataList(
      int firstRow,
      int numRows,
    ...
    try {
      Response response =
          subscriptionsService.getSubscriptionsForOrgWithFiltering(states, pagination);
    ...
    try {
      ...
      setTotalCount(
          subscriptionsService
              .getSubscriptionsForOrgSizeWithFiltering(states, pagination)
              .intValue());
    } catch (Exception e) {
      logger.logError(Log4jLogger.SYSTEM_LOG, e, LogMessageIdentifier.ERROR);
    }
  ...
  public void setSelectedSubscription(POSubscriptionForList selectedSubscription) {

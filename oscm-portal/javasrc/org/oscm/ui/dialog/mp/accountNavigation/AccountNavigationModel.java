...
public class AccountNavigationModel implements Serializable {
  ...
  static final String MARKETPLACE_ACCOUNT_ADMINISTRATION_TITLE =
      "marketplace.account.administration.title";
  ...
  private void initHiddenElement() {
    getHiddenElement().add(HiddenUIConstants.MARKETPLACE_MENU_ITEM_ACCOUNT_PROFILE);
    getHiddenElement().add(HiddenUIConstants.MARKETPLACE_MENU_ITEM_ACCOUNT_PAYMENT);
    getHiddenElement().add(HiddenUIConstants.MARKETPLACE_MENU_ITEM_ACCOUNT_SUBSCRIPTIONS);
    getHiddenElement().add(HiddenUIConstants.MARKETPLACE_MENU_ITEM_ACCOUNT_USERS);
    getHiddenElement().add(HiddenUIConstants.MARKETPLACE_MENU_ITEM_ACCOUNT_UNITS);
    getHiddenElement().add(HiddenUIConstants.MARKETPLACE_MENU_ITEM_ACCOUNT_REPORTS);
    getHiddenElement().add(HiddenUIConstants.MARKETPLACE_MENU_ITEM_ACCOUNT_PROCESSES);
    getHiddenElement().add(HiddenUIConstants.MARKETPLACE_MENU_ITEM_ACCOUNT_OPERATIONS);
    getHiddenElement().add(HiddenUIConstants.MARKETPLACE_MENU_ITEM_ACCOUNT_ADMINISTRATION);
  }

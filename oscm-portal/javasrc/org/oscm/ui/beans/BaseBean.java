...
/**
 * Base class for all backing beans which provides the getters for the services and some helper
 * methods.
 */
public class BaseBean {
  public UiDelegate ui = new UiDelegate();

  private static final Log4jLogger logger = LoggerFactory.getLogger(BaseBean.class);

  /** Helper class to map a list with value objects to a list with model objects */
  public abstract static class Vo2ModelMapper<V, M> {

    /**
     * Perform the mapping of the value object list to the model list.
     *
     * @param voList the value object list
  ...
  public static final String ERROR_USER_CREATE_MAIL_NOT_INTERNAL =
      "error.user.create.mail.notInternal";
  public static final String ERROR_USER_CREATE_INSUFFICIENT_ROLES =
      "error.user.create.insufficientRoles";
  public static final String ERROR_USER_LDAP_SEARCH_LIMIT_EXCEEDED =
      "error.user.ldapSearchLimitExceeded";
  ...
  public static final String ERROR_REGISTRATION_ACKNOWLEDGE_MAIL =
      "error.registration.acknowledge.mail";
  ...
  public static final String ERROR_PARAMETER_VALUE_OUT_OF_RANGE =
      "error.parameter.value.outOfRange";
  ...
  public static final String ERROR_PARAMETER_VALUE_TO_LONG =
      "javax.faces.validator.LengthValidator.MAXIMUM";
  public static final String ERROR_PRICEMODEL_INPUT = "error.priceModel.input";
  public static final String ERROR_PRICEMODEL_INVALID_DECIMAL_SEPRATOR =
      "error.priceModel.invalid.decimal.input";
  public static final String ERROR_PRICEMODEL_INVALID_FRACTIONAL_PART =
      "error.priceModel.invalid.fractional.part";
  public static final String ERROR_SERVICE_SAVED_MARKETPLACE_DELETED =
      "error.service.savedButNotPublished_marketplaceDeleted";
  public static final String ERROR_SERVICE_SAVED_PUBLISHING_NOT_PERMITTED =
      "error.service.savedButNotPublished_publishingNotPermitted";
  public static final String ERROR_SERVICE_NOT_AVAILABLE = "error.service.notAvailable";
  public static final String ERROR_SERVICE_NOT_AVAILABLE_LOGGED_IN =
      "error.service.notAvailableLoggedIn";
  public static final String ERROR_SERVICE_NOT_AVAILABLE_ANYMORE =
      "error.service.notAvailableAnymore";
  public static final String ERROR_SERVICE_INVALID_KEY = "error.service.invalidKey";
  public static final String ERROR_SHOP_TRANSLATIONS_FILEFORMAT =
      "error.shop.translations.fileformat";
  public static final String ERROR_SHOP_TRANSLATIONS_FILENAME_PROPERTIES =
      "error.shop.translations.filename.properties";
  ...
  public static final String ERROR_TRANSLATIONS_ONELANGUAGE =
      "error.translations.onelanguageallowed";
  ...
  public static final String ERROR_DELETE_USER_FROM_EXPIRED_SUBSCRIPTION =
      "error.deleteUser.subscriptionExpired";
  public static final String ERROR_UPLOAD_SIZE_LIMIT_EXCEEDED = "error.upload.sizeLimitExceeded";
  public static final String ERROR_UPLOAD_SIZE_LIMIT_EXCEEDED_KNOWNMAX =
      "error.upload.sizeLimitExceeded.konwnMax";
  ...
  public static final String ERROR_DISCOUNT_INVALID_FRACTIONAL_PART =
      "error.discount.invalid.fractional.part";
  ...
  public static final String ERROR_SUBSCRIPTION_NOT_FOUND =
  ...
  public static final String ERROR_USER_GROUP_TO_USER_NOT_FOUND =
      "ex.ObjectNotFoundException.USER_GROUP_TO_USER";
  public static final String ERROR_USERGROUP_NOT_FOUND_EXCEPTION = "errorUserGroupNotFound";
  public static final String ERROR_USER_GROUP_TO_USER_NOT_FOUND_EXCEPTION =
      "errorUserGroupToUserNotFound";
  public static final String ERROR_USERGROUP_NOT_FOUND_EXCEPTION_UNIT_ADMIN =
      "errorUserGroupNotFoundUnitAdmin";
  public static final String ERROR_NO_CURRENCIES = "error.no.currencies";
  public static final String ERROR_NOT_AVALIABLE_SERVICE =
  ...
  public static final String ERROR_FILE_IMPORT_FAILED_ISOCODE_INVALID =
      "ex.ValidationException.FILE_IMPORT_FAILED_ISOCODE_INVALID";
  public static final String ERROR_FILE_IMPORT_FAILED_ISOCODE_NOT_SUPPORTED =
      "ex.ValidationException.LANGUAGE_ISOCODE_NOT_SUPPORTED";
  public static final String ERROR_FILE_IMPORT_NO_lANGUAGE =
      "ex.PropertiesImportException.NONE_LANGUAGE_CODE";
  public static final String ERROR_FILE_IMPORT_LANGUAGE_NOT_SUPPORTED =
      "ex.PropertiesImportException.LANGUAGE_NOT_SUPPORTED";
  public static final String ERROR_FILE_IMPORT_TRANSLATIONS_MISSING =
      "ex.PropertiesImportException.TRANSLATIONS_MISSING";
  public static final String ERROR_FILE_IMPORT_TRANSLATIONS_MULTIPLEKEY_EXISTING =
      "error.translations.multiplekey.existing";
  public static final String ERROR_BILLING_CONTACT_MODIFIED_OR_DELETED_CONCURRENTLY =
      "error.paymentInfo.modifiedConcurrently";
  public static final String ERROR_ACOUNT_MODIFIED_OR_DELETED_CONCURRENTLY =
      "error.editUser.modifiedConcurrently";
  public static final String ERROR_UNIT_MODIFIED_OR_DELETED_CONCURRENTLY =
      "error.editUnit.modifiedConcurrently";
  public static final String ERROR_SUBSCRIPTION_MODIFIED_OR_DELETED_CONCURRENTLY =
      "error.editSubscription.modifiedConcurrently";
  public static final String ERROR_REVENUESHARE_INVALID_FRACTIONAL_PART =
      "error.revenueshare.invalid.fractional.part";
  public static final String ERROR_REVENUESHARE_VALUE = "error.revenueshare.value";
  public static final String ERROR_RECOVERPASSWORD_INVALID_LINK =
      "error.recoverpassword.invalid.link";
  ...
  public static final String ERROR_INVALID_SAML_RESPONSE_STATUS_CODE =
      "error.invalid.samlResponseStatusCode";
  ...
  public static final String ERROR_TO_PROCEED_SELECT_UNIT =
      "error.subscription.unitHasToBeSelected";
  public static final String ERROR_EXTERNAL_PRICEMODEL_NOT_AVAILABLE =
      "error.externalPricemodel.notavailable";
  public static final String ERROR_BILLING_ID_ALREADY_EXISTS =
      "ex.NonUniqueBusinessKeyException.BILLING_ADAPTER";
  ...
  public static final String WARNING_SUPPORTEDLANGUAGE_LOCALE_INVALID =
      "warning.supportedlanguage.locale.invalid";
  public static final String WARNING_SUPPORTEDLANGUAGE_LOCALE_DEACTIVATED =
      "warning.supportedlanguage.locale.deactivated";
  public static final String WARNING_OWNER_NOT_A_UNIT_ADMIN =
      "warning.editSubscription.subscriptionOwner.administrator";
  public static final String WARNING_OWNER_IS_SUB_MAN =
      "warning.editSubscription.subscriptionOwner.subscriptionManager";
  public static final String WARNING_UNIT_NOT_SELECTED_UNIT_ADMIN =
      "warning.editSubscription.subscriptionUnitNotSelected";
  public static final String WARNING_PAYMENT_TYPES_NOT_USED = "warning.paymentTypesAreNotUsed";
  public static final String WARNING_NO_CUSTOMER_ACCESS_TO_RESTRICTED_MPL =
      "warning.noCustomerAccessToRestrictedMpl";
  public static final String WARNING_TENANT_DEF_NOT_COMPLETE =
      "warning.tenantDefinitionNotComplete";

  public static final String INFO_BILLING_CONTACT_DELETED = "info.billingContact.deleted";
  public static final String INFO_BILLING_CONTACT_DELETED_CONCURRENTLY =
      "info.billingContact.deletedConcurrently";
  ...
  public static final String INFO_PAYMENT_INFO_DELETED_CONCURRENTLY =
      "info.paymentInfo.deletedConcurrently";
  ...
  public static final String INFO_DIRECT_SUBSCRIPTION_CREATED_DISABLE_INFO =
      "info.direct.subscription.created.disable.info";
  ...
  public static final String INFO_PRICEMODEL_FOR_SUBSCRIPTION_SAVED =
      "info.pricemodel.subscription.saved";
  public static final String INFO_PRICEMODEL_FOR_CUSTOMER_DELETED =
      "info.pricemodel.customer.deleted";
  public static final String INFO_PRICEMODEL_FOR_CUSTOMER_DELETED_CONCURRENTLY =
      "info.pricemodel.customer.deletedConcurrently";
  ...
  public static final String LABEL_PRICE_MODEL_PRICE_AND_UNIT =
      "priceModel.text.combinePriceAndUnit";
  ...
  public static final String MARKETPLACE_LOGIN = Marketplace.MARKETPLACE_ROOT + "/login.jsf";

  public static final String MARKETPLACE_ERROR_PAGE =
      Marketplace.MARKETPLACE_ROOT + "/errorPage.jsf";
  public static final String MARKETPLACE_USERS_PAGE =
      Marketplace.MARKETPLACE_ROOT + "/account/users.jsf";
  public static final String MARKETPLACE_UNITS_PAGE =
      Marketplace.MARKETPLACE_ROOT + "/account/users.jsf";
  public static final String MARKETPLACE_REDIRECT = Marketplace.MARKETPLACE_ROOT + "/redirect.jsf";
  public static final String MARKETPLACE_ACCESS_DENY_PAGE =
      Marketplace.MARKETPLACE_ROOT + "/accessDeniedPage.jsf";

  public static final String SAML_SP_LOGIN_AUTOSUBMIT_PAGE =
      Marketplace.MARKETPLACE_ROOT + "/serviceProvider.jsf";
  public static final String MANAGE_PAYMENT_TYPES_PAGE =
      "/organization/managePaymentEnablement.jsf";
  public static final String MANAGE_PAYMENT_TYPES_PAGE_XHTML =
      "/organization/managePaymentEnablement.xhtml";
  ...
  protected MarketplaceService getMarketplaceService() {
    marketplaceService = getService(MarketplaceService.class, marketplaceService);
    return marketplaceService;
  }

  /** Returns the marketplace management service that contains performance optimized methods. */
  protected MarketplaceServiceInternal getMarketplaceServiceInternal() {
    marketplaceServiceInternal =
        getService(MarketplaceServiceInternal.class, marketplaceServiceInternal);
  ...
  protected OperationRecordService getOperationRecordService() {
    operationRecordService = getService(OperationRecordService.class, operationRecordService);
  ...
  protected SubscriptionService getSubscriptionService() {
    subscriptionService = getService(SubscriptionService.class, subscriptionService);
  ...
  protected SubscriptionsService getSubscriptionsService() {
    subscriptionsService = getService(SubscriptionsService.class, subscriptionsService);
    return subscriptionsService;
  }

  /** Returns the subscription management service that contains performance optimized methods. */
  protected SubscriptionServiceInternal getSubscriptionServiceInternal() {
    subscriptionServiceInternal =
        getService(SubscriptionServiceInternal.class, subscriptionServiceInternal);
  ...
  protected ServiceProvisioningService getProvisioningService() {
    provisioningService = getService(ServiceProvisioningService.class, provisioningService);
    return provisioningService;
  }

  /** Returns the service provisioning service that contains performance optimized methods. */
  protected ServiceProvisioningServiceInternal getProvisioningServiceInternal() {
    provisioningServiceInternal =
        getService(ServiceProvisioningServiceInternal.class, provisioningServiceInternal);
    return provisioningServiceInternal;
  }

  public ExternalPriceModelService getExternalPriceModelService() {
    externalPriceModelService =
        getService(ExternalPriceModelService.class, externalPriceModelService);
  ...
  protected SearchServiceInternal getSearchServiceInternal() {
    searchServiceInternal = getService(SearchServiceInternal.class, searchServiceInternal);
  ...
  protected ConfigurationService getConfigurationService() {
    configurationService = getService(ConfigurationService.class, configurationService);
  ...
  protected TriggerDefinitionService getTriggerDefinitionService() {
    triggerDefinitionService = getService(TriggerDefinitionService.class, triggerDefinitionService);
  ...
  protected PaymentService getPaymentProcessingService() {
    paymentProcessingService = getService(PaymentService.class, paymentProcessingService);
  ...
  protected ReviewInternalService getReviewService() {
    reviewInternalService = getService(ReviewInternalService.class, reviewInternalService);
  ...
  protected PasswordRecoveryService getPasswordRecoveryService() {
    passwordRecoveryService = getService(PasswordRecoveryService.class, passwordRecoveryService);
    return passwordRecoveryService;
  }

  /** Returns the account service that contains performance optimized methods. */
  protected ServiceProvisioningServiceLocalizationLocal
      getServiceProvisioningServiceLocalizationLocal() {
  ...
  protected CategorizationService getCategorizationService() {
    categorizationService = getService(CategorizationService.class, categorizationService);
    return categorizationService;
  }

  protected LandingpageConfigurationService getLandingpageService() {
    landingpageService = getService(LandingpageConfigurationService.class, landingpageService);
    return landingpageService;
  }

  protected SubscriptionDetailsService getSubscriptionDetailsService() {
    subscriptionDetailsService =
        getService(SubscriptionDetailsService.class, subscriptionDetailsService);
    return subscriptionDetailsService;
  }

  protected LandingpageService getShowLandingpage() {
    showLandingpageService = getService(LandingpageService.class, showLandingpageService);
    return showLandingpageService;
  }

  protected AccountServiceManagement getAccountServiceManagement() {
    accountServiceManagement = getService(AccountServiceManagement.class, accountServiceManagement);
    return accountServiceManagement;
  }

  protected ManageLanguageService getManageLanguageService() {
    manageLanguageService = getService(ManageLanguageService.class, manageLanguageService);
    return manageLanguageService;
  }

  protected LocalizedDataService getLocalizedDataService() {
    localizedDataService = getService(LocalizedDataService.class, localizedDataService);
  ...
  /**
   * Return the given service object if it is not null. Otherwise a new service object is looked up
   * and returned. If the local variable useMockService is set to true the MockService will be
   * returned.
   *
   * @param <T> the service interface
   * @param clazz the class of the service interface
   * @param service if not null this service is returned
   * @return the given service object if it is not null. Otherwise a new service object is looked up
   *     and returned
   */
  ...
  /**
   * Gets the current HTTP servlet request from the faces context. This method may be stubbed.
   *
   ...
   *
   * @param key lookup key
   * @param value attribute value to store
   */
   ...
   *
   * @param facesContext the FacesContext to get the session from
  ...
  /**
   * Get the current user from the session without throwing an exception if the user is not found in
   * the session.
   *
   * @return the current user from the session, or <code>null</code> if no user is found in the
   *     session.
   */
  public VOUserDetails getUserFromSessionWithoutException() {
    return getUserFromSessionWithoutException(FacesContext.getCurrentInstance());
  }

  public static VOUserDetails getUserFromSessionWithoutException(FacesContext facesContext) {
    HttpServletRequest request =
        (HttpServletRequest) facesContext.getExternalContext().getRequest();
    return (VOUserDetails) request.getSession().getAttribute(Constants.SESS_ATTR_USER);
  }

  /**
   * Store a new user value object in the session (e.g. after an update of the current user).
   *
   * @param voUserDetails User details.
   */
  protected void setUserInSession(final VOUserDetails voUserDetails) {
    ...
    request.getSession().setAttribute(Constants.SESS_ATTR_USER, voUserDetails);
  }
  ...
  public boolean isCurrentUserRolesChanged() {
    Set<UserRoleType> userRoles = getIdService().getCurrentUserDetails().getUserRoles();
    Set<UserRoleType> currentUserRoles = getUserFromSessionWithoutException().getUserRoles();
  ...
  /**
   * Append a FacesMessage to the current faces context. The FacesMessage is added to the set of
   * messages associated with the specified client identifier, if clientId is not null. If clientId
   * is null, this FacesMessage is assumed to not be associated with any specific component
   * instance.
   *
   * @param clientId - the id of the client component to which the message is associated. If null
   *     the message is not associated with any specific component.
   * @param severity - the message severity.
   * @param key - the key of the message in the resource bundle.
   * @param params - option parameters of the message.
   */
  ...
  /**
   * Append a FacesMessage with one parameter to the current faces context. The FacesMessage is
   * added to the set of messages associated with the specified client identifier, if clientId is
   * not null. If clientId is null, this FacesMessage is assumed to not be associated with any
  ...
  /**
   * Append a FacesMessage without parameter to the current faces context. The FacesMessage is added
   * to the set of messages associated with the specified client identifier, if clientId is not
   * null. If clientId is null, this FacesMessage is assumed to not be associated with any specific
   * component instance.
   *
   * @param clientId - the id of the client component to which the message is associated. If null
   *     the message is not associated with any specific component.
  ...
  protected void addInfoOrProgressMessage(boolean info, String infoKey, String infoParam) {
    if (info) {
      addMessage(null, FacesMessage.SEVERITY_INFO, infoKey, infoParam);
    } else {
      addMessage(PROGRESS_PANEL, FacesMessage.SEVERITY_INFO, PROGRESS_DEFAULT, (String) null);
    }
  }
  ...
  /**
   * Invoke the BeanUtils.copyProperties() method and convert the possible exceptions into
   * SaaSSystemExceptions
   *
  ...
  /** Delegates to {@link JSFUtils#writeContentToResponse(byte[], String, String)} */
  ...
  /** Delegates to {@link JSFUtils#writeContentToResponse(byte[], String, String, FacesContext)} */
  protected void writeContentToResponse(
      byte[] content, String filename, String contentType, FacesContext fc) throws IOException {
  ...
  public static String getMarketplaceIdStatic() {
    ...
    if (isBlank(marketplaceId)) {
      HttpSession session = request.getSession(false);
      if (session != null) {
        marketplaceId = (String) session.getAttribute(Constants.REQ_PARAM_MARKETPLACE_ID);
      }
    }
  ...
  protected boolean isLoggedInAndMarketplaceOwner() {
    VOUserDetails user = getUserFromSessionWithoutException(FacesContext.getCurrentInstance());
    return user != null && user.getUserRoles().contains(UserRoleType.MARKETPLACE_OWNER);
  }
  ...
  protected boolean isLoggedInAndPlatformOperator() {
    ...
    return user != null && user.getUserRoles().contains(UserRoleType.PLATFORM_OPERATOR);
  }

  /**
   * Returns true if current user is logged in as Unit Administrator, but not as a Organization
   * Administrator.
   *
   * @return true if current user is logged in as Unit Administrator, but not as a Organization
   *     Administrator
   */
  ...
  protected boolean isLoggedIn() {
    return getUserFromSessionWithoutException(FacesContext.getCurrentInstance()) != null;
  }

  /** Return the current user language or browser language if user is not logged in. */
  ...
  protected String getSelectedServiceQueryPart(SessionBean sessionBean) {
    ...
    try {
      ...
      String value =
          URLEncoder.encode(
              String.valueOf(sessionBean.getSelectedServiceKeyForCustomer()), charEncoding);
      selectedService = '?' + name + '=' + value;
    } catch (UnsupportedEncodingException e) {
      extContext.log(getClass().getName() + ".getSelectedServiceQueryPart()", e);
    }
  ...
  /**
   * Tells JSF that it should reset the values of all UIInput children. Which makes JSF to reload
   * the values from the backing beans.<br>
   * <br>
   * Use case: When a validation fails, JSF will not reload the values from the backing beans, to
   * prevent loss of user input. If the reload is wanted, then this method must be explicitly
   * called.
   *
  ...
  /**
   * Removes the specified components, searching down the UI tree beginning with the view root, from
   * the children lists of their parents, so they are rebuilt and rendered again. This might be
   * necessary after changing the UI model without navigating away from the page.
   *
   * @param componentIds the IDs of the components to be reseted
   * @see http://wiki.apache.org/myfaces/ClearInputComponents
   */
  protected void resetUIComponents(Set<String> componentIds) {
    JSFUtils.resetUIComponents(getFacesContext().getViewRoot(), componentIds);
  }
  ...
  public boolean isMarketplaceOwner() {
    ...
    List<VOMarketplace> marketplaces = getMarketplaceService().getMarketplacesOwned();
  ...
  /**
   * Checks if the internal token matches the one submitted from the form. If the tokens don't
   * match, the action should not be processed.
   *
   * @return <code>true</code> if internal and submitted token match otherwise <code>false</code>
   */
  ...
  /**
   * Returns text translated from resource bundle with given parameters. This non-static variant may
   * be mocked for testing purpose.
   */
  ...
  /**
   * This method is used as generic binding for all input fields of the billing contact dialog. The
   * binding was introduced in the context of fixing bug #7843. The value of the passed component is
   * will be cleared to make sure that the value-binding (happens in a later phase) can set the
   * values which are eventually shown in the UI.
   *
   * @param input the UIinput of the webpage.
   */
  ...
  /**
   * Introduced in the context of fixing bug #7843 The getter is required for formal reasons. It's
   * not necessary to pass back a component, also it's not possible to pass back the component
   * passed into the setter, because the bean has request scope (all private members would be clears
   * the time the getter is called)
   *
   * @return null
   */
   ...
   *
   * @return true if current user is logged in and has Subscription Manager role assigned
   */
  public boolean isLoggedInAndSubscriptionManager() {
    VOUserDetails user = this.getUserFromSessionWithoutException();
    return user != null && user.getUserRoles().contains(UserRoleType.SUBSCRIPTION_MANAGER);
  }
  ...
  public boolean isLoggedInAndAllowedToSubscribe() {
    VOUserDetails user = this.getUserFromSessionWithoutException();
    return user != null
        && (user.getUserRoles().contains(UserRoleType.SUBSCRIPTION_MANAGER)
            || user.getUserRoles().contains(UserRoleType.ORGANIZATION_ADMIN)
            || user.getUserRoles().contains(UserRoleType.UNIT_ADMINISTRATOR));
  }
   ...
   *
   * @return true if user is organization admin or subscription manager or technology manager,
   *     otherwise false.
   */
  ...
  public ResourceBundle getResourceBundle(Locale locale) {
    return ResourceBundle.getBundle(
        DbMessages.class.getName(), locale, Thread.currentThread().getContextClassLoader());
  }

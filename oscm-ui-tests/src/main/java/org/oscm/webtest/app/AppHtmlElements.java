...
public class AppHtmlElements {
  ...
  public static final String APP_STATUS_MSG_ERROR = "statusPanel statusError";
  ...
  public static final String APP_SAVE_CONFIG_CONTROLLER_BUTTON_CLASS =
      "configurationSettings:j_idt62";
  ...
  public static final String APP_BROWSE_FILE_BUTTON = "templateForm";

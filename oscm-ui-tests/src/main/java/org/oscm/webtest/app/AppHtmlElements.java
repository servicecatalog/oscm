...
public class AppHtmlElements {
  ...
  public static final String APP_CONFIG_LICLASS_STATUS_MSG_FIELD_UPPER = "//span[@id='status']";
  public static final String APP_CONFIG_LICLASS_STATUS_MSG_FIELD_DOWN = "//span[2]/span";

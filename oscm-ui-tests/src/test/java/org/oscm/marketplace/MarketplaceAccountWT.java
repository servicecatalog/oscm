...
public class MarketplaceAccountWT {
  ...
  public void test01fillPersonalData() {
    ...
    tester.writeValue(
        MarketplaceHtmlElements.MARKETPLACE_ACCOUNT_PROFILE_EMAIL_FIELD, "jacob.smith@mail.com");
  ...
  public void test02addBillingAddress() throws InterruptedException {
    ...
    tester.writeValue(
        MarketplaceHtmlElements.MARKETPLACE_ACCOUNT_PAYMENT_EMAIL_FIELD, "smiths.organization@mail.com");
    tester.writeValue(
...
//  @Test
  public void test04addUser() throws InterruptedException {
    ...
    tester.writeValue(MarketplaceHtmlElements.MARKETPLACE_ACCOUNT_PROFILE_LAST_NAME_FIELD, "Smith");
    tester.writeValue(
        MarketplaceHtmlElements.MARKETPLACE_ACCOUNT_PROFILE_EMAIL_FIELD, "isabella.smith@mail.com");

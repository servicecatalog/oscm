...
public class MarketplacePlaygroundAccountWT {
    ...
    public void test01addBillingAddress() throws Exception {
        ...
        tester.clickElement(
                MarketplaceHtmlElements.MARKETPLACE_ACCOUNT_PAYMENTS_ADD_BILLING_ADDRESS);
    ...
    public void test02addBillingAddressFailure() {
        ...
        assertTrue(tester.verifyFoundElement(By.id(MarketplaceHtmlElements.MARKETPLACE_ACCOUNT_PAYMENTS_BILLING_MODAL_ERROR)));
    }
    ...
    public void test03removeBillingAddress() throws InterruptedException {
        ...
        Thread.sleep(1000);
        tester.clickElement(MarketplaceHtmlElements.MARKETPLACE_ACCOUNT_PAYMENTS_DELETE_BILLING_ADDRESS);
        Thread.sleep(1000);
        tester.clickElement(MarketplaceHtmlElements.MARKETPLACE_ACCOUNT_PAYMENTS_DELETE_BILLING_CONFIRM);
    ...
    public void test04addPaymentTypeFailure() throws InterruptedException {
        ...
        assertTrue(tester.verifyFoundElement(By.id(MarketplaceHtmlElements.MARKETPLACE_ACCOUNT_PAYMENTS_PAYMENT_MODAL_ERROR)));
    }

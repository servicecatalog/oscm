...
public class MarketplaceAccountWT {
  ...
  public void test01fillPersonalData() {
    ...
    tester.writeValue(
        PortalHtmlElements.MARKETPLACE_ACCOUNT_PROFILE_EMAIL_FIELD, "jacob.smith@mail.com");
    ...
    tester.writeValue(
        PortalHtmlElements.MARKETPLACE_ACCOUNT_PROFILE_ORGANIZATION_FIELD, "Smiths organization");
    tester.writeValue(
        PortalHtmlElements.MARKETPLACE_ACCOUNT_PROFILE_ORGANIZATION_EMAIL_FIELD,
        "smiths.organization@mail.com");
    tester.writeValue(
        PortalHtmlElements.MARKETPLACE_ACCOUNT_PROFILE_ORGANIZATION_ADDRESS_FIELD,
        "Australia\nSmall Village 10");
  ...
  public void test02addBillingAddress() throws InterruptedException {
    ...
    tester.clickElementXPath(
        PortalHtmlElements.MARKETPLACE_ACCOUNT_PAYMENT_ADD_BILLING_ADDRESS_BUTTON);
    tester.waitForElement(By.id(PortalHtmlElements.MARKETPLACE_ACCOUNT_PAYMENT_DISPLAY_FIELD), 10);
    Thread.sleep(1000);
    tester.writeValue(
        PortalHtmlElements.MARKETPLACE_ACCOUNT_PAYMENT_DISPLAY_FIELD, "Smiths billing");
    tester.writeValue(
        PortalHtmlElements.MARKETPLACE_ACCOUNT_PAYMENT_DISPLAY_FIELD, "Smiths billing");
    tester.writeValue(
        PortalHtmlElements.MARKETPLACE_ACCOUNT_PAYMENT_NAME_FIELD, "Smiths organization");
    tester.writeValue(
        PortalHtmlElements.MARKETPLACE_ACCOUNT_PAYMENT_EMAIL_FIELD, "smiths.organization@mail.com");
    tester.writeValue(
        PortalHtmlElements.MARKETPLACE_ACCOUNT_PAYMENT_ADDRESS_FIELD,
        "Australia\nSmall Village 10");
  ...
  public void test03addPaymentType() throws InterruptedException {
    ...
    Thread.sleep(1000);
    tester.writeValue(
        PortalHtmlElements.MARKETPLACE_ACCOUNT_PAYMENT_PAYMENT_NAME_FIELD, "Smiths payment");
  ...
  public void test04addUser() {
    ...
    tester.writeValue(PortalHtmlElements.MARKETPLACE_ACCOUNT_PROFILE_LAST_NAME_FIELD, "Smith");
    tester.writeValue(
        PortalHtmlElements.MARKETPLACE_ACCOUNT_PROFILE_EMAIL_FIELD, "isabella.smith@mail.com");
  ...
  public void test06addOrganization() throws InterruptedException {
    ...
    tester.writeValue(
        PortalHtmlElements.MARKETPLACE_ACCOUNT_ORGANIZATION_ORG_NAME_FIELD, "Isabels organization");
    tester.writeValue(
        PortalHtmlElements.MARKETPLACE_ACCOUNT_ORGANIZATION_ORG_ID_FIELD, "isabelorg");
    tester.writeValue(
        PortalHtmlElements.MARKETPLACE_ACCOUNT_ORGANIZATION_ORG_DESCRIPTION_FIELD,
  ...
  public void test07addUsersToOrganization() throws InterruptedException {
    tester.clickElement(
        PortalHtmlElements.MARKETPLACE_ACCOUNT_ORGANIZATION_ADD_ADMINISTRATOR_CHECKBOX);
    tester.clickElement(PortalHtmlElements.MARKETPLACE_ACCOUNT_ORGANIZATION_ADD_USER_CHECKBOX);
    tester.selectDropdown(
        PortalHtmlElements.MARKETPLACE_ACCOUNT_ORGANIZATION_ASSIGN_ROLE_DROPDOWN, "ADMINISTRATOR");
    tester.clickElementXPath(
        PortalHtmlElements.MARKETPLACE_ACCOUNT_ORGANIZATION_ASSIGN_ROLE_BUTTON);
    Thread.sleep(1000);
    assertTrue(
        tester
            .readInfoMessage()
  ...
  public void test08deleteOrganization() throws InterruptedException {
    ...
    Thread.sleep(1000);
    tester.clickElementXPath(
        PortalHtmlElements.MARKETPLACE_ACCOUNT_ORGANIZATION_DELETE_CONFIRM_BUTTON);
    Thread.sleep(1000);
    assertTrue(
        tester
            .readInfoMessage()
  ...
  public void test09addProcessTrigger() throws InterruptedException {
    ...
    Thread.sleep(1000);
    tester.writeValue(
        PortalHtmlElements.MARKETPLACE_ACCOUNT_PROCESSES_TRIGGER_NAME_FIELD, "Trigger");
    tester.selectDropdown(
        PortalHtmlElements.MARKETPLACE_ACCOUNT_PROCESSES_TRIGGER_TYPE_DROPDOWN,
        "SUBSCRIBE_TO_SERVICE");
    tester.selectDropdown(
        PortalHtmlElements.MARKETPLACE_ACCOUNT_PROCESSES_TARGET_TYPE_DROPDOWN, "REST_SERVICE");
    tester.writeValue(
        PortalHtmlElements.MARKETPLACE_ACCOUNT_PROCESSES_TARGET_URL_FIELD, "https://webiste.io");
